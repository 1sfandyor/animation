  ...
  var Fi = u(() => {
      window.tram = (function (e) {
          ...
          function c(l, v, y) {
              ...
              var T = y;
              return Pt.test(l) || !Et.test(l) ? (T = parseInt(l, 10)) : Et.test(l) && (T = 1e3 * parseFloat(l)), 0 > T && (T = 0), T === T ? T : y;
          }
          function f(l) {
          ...
          var p = (function (l, v, y) {
                  ...
                  function z(re, ge) {
                      ...
                      return (
                          ...
                          (W.open = function (Me) {
                              if (((le = {}), _(Me) ? (le = Me.call(W, it, Se, W, re)) : T(Me) && (le = Me), T(le))) for (var Or in le) v.call(le, Or) && (it[Or] = le[Or]);
              ...
              D = function (l) {
                  ...
                  for (v = 0; v < I.length; v++) if (((y = I[v] + T), y in M.style)) return { dom: y, css: x[v] + l };
              },
              X = (t.support = { bind: Function.prototype.bind, transform: D("transform"), transition: D("transition"), backface: D("backface-visibility"), timing: D("transition-timing-function") });
          if (X.transition) {
              var $ = X.timing.dom;
              if (((M.style[$] = h["ease-in-back"][0]), !M.style[$])) for (var te in g) h[te][0] = g[te];
          }
          var L = (t.frame = (function () {
              ...
              j = p(function (l) {
                  function v(Z, fe) {
                      ...
                      if (!fe.weak || !this.props[pe]) {
                          var Ke = De[0],
                              Ue = this.props[pe];
                          return Ue || (Ue = this.props[pe] = new Ke.Bare()), Ue.init(this.$el, me, De, fe), Ue;
                      }
                  }
                  function y(Z, fe, me) {
                      if (Z) {
                          var pe = typeof Z;
                          if ((fe || (this.timer && this.timer.destroy(), (this.queue = []), (this.active = !1)), pe == "number" && fe)) return (this.timer = new he({ duration: Z, context: this, complete: O })), void (this.active = !0);
                          if (pe == "string" && fe) {
                              switch (Z) {
                                  case "hide":
                                      W.call(this);
                          ...
                          if (pe == "object") {
                              ...
                              it.call(
                                  ...
                                  Se.call(this),
                                  De > 0 && ((this.timer = new he({ duration: De, context: this })), (this.active = !0), fe && (this.timer.complete = O));
                              var Ke = this,
                                  Ue = !1,
                                  an = {};
                              L(function () {
                  ...
                  function T(Z) {
                      (Z = c(Z, 0)), this.active ? this.queue.push({ options: Z }) : ((this.timer = new he({ duration: Z, context: this, complete: O })), (this.active = !0));
                  }
                  function _(Z) {
                      return this.active ? (this.queue.push({ options: Z, args: arguments }), void (this.timer.complete = O)) : f("No active transition timer. Use start() or wait() before then().");
                  }
                  function O() {
                  ...
                  function z(Z) {
                      ...
                      var fe;
                      typeof Z == "string" ? ((fe = {}), (fe[Z] = 1)) : (fe = typeof Z == "object" && Z != null ? Z : this.props), it.call(this, fe, Me), Se.call(this);
                  }
                  function re(Z) {
                  ...
                  function it(Z, fe, me) {
                      var pe,
                          ...
                          an = fe !== Me,
                          be = {};
                      for (pe in Z) (Ke = Z[pe]), pe in _e ? (be.transform || (be.transform = {}), (be.transform[pe] = Ke)) : (w.test(pe) && (pe = r(pe)), pe in B ? (be[pe] = Ke) : (Ue || (Ue = {}), (Ue[pe] = Ke)));
                      for (pe in be) {
                  ...
                  function ke(Z, fe) {
                      l[Z] = function () {
                          return this.children ? pI.call(this, fe, arguments) : (this.el && fe.apply(this, arguments), this);
                      };
                  }
                  function pI(Z, fe) {
                      var me,
                  ...
                  (l.init = function (O, z, re, ge) {
                      ...
                      re[2] && (W = re[2]),
                          ...
                          de.fallback || ge.fallback
                              ...
                              : ((this.animate = this.transition), (this.string = this.name + ee + this.duration + "ms" + (this.ease != "ease" ? ee + h[this.ease][0] : "") + (this.delay ? ee + this.delay + "ms" : "")));
                  }),
                      (l.set = function (O) {
                      ...
                      (l.fallback = function (O) {
                          ...
                          (O = this.convert(O, this.type)),
                              this.auto && (z == "auto" && (z = this.convert(this.get(), this.type)), O == "auto" && (O = v.call(this))),
                              (this.tween = new J({ from: z, to: O, duration: this.duration, delay: this.delay, ease: this.ease, update: this.update, context: this }));
                      }),
                      (l.get = function () {
              ...
              ce = p(F, function (l, v) {
                  function y(T, _) {
                      var O, z, re, ge, W;
                      for (O in T) (ge = _e[O]), (re = ge[0]), (z = ge[1] || O), (W = this.convert(T[O], re)), _.call(this, z, W, re);
                  }
                  (l.init = function () {
                      ...
                      (l.values = function (T) {
                          ...
                          return (
                              y.call(this, T, function (z, re, ge) {
                                  (O[z] = re), this.current[z] === void 0 && ((_ = 0), ~z.indexOf("scale") && (_ = 1), (this.current[z] = this.convert(_, ge)));
                              }),
                              O
                          );
                      });
              ...
              J = p(function (l) {
                  ...
                  (l.init = function (W) {
                      ...
                      le === void 0 && (le = z.from),
                          Se === void 0 && (Se = z.to),
                          (this.unit = W.unit || ""),
                          typeof le == "number" && typeof Se == "number" ? ((this.begin = le), (this.change = Se - le)) : this.format(Se, le),
              ...
              vt = p(J, function (l, v) {
                  (l.init = function (y) {
                      ...
                      var T, _;
                      for (T in y.values) (_ = y.values[T]), this.current[T] !== _ && this.tweens.push(new J({ name: T, from: this.current[T], to: _, duration: y.duration, delay: y.delay, ease: y.ease, autoplay: !1 }));
                      this.play();
                  }),
                      (l.render = function (y) {
                          var T,
          ...
          var d = e.style,
              ...
              _e = {};
          X.transform && ((B.transform = [ce]), (_e = { x: [q, "translateX"], y: [q, "translateY"], rotate: [G], rotateX: [G], rotateY: [G], scale: [m], scaleX: [m], scaleY: [m], skew: [G], skewX: [G], skewY: [G] })),
              X.transform && X.backface && ((_e.z = [q, "translateZ"]), (_e.rotateZ = [G]), (_e.scaleZ = [m]), (_e.perspective = [C]));
          var Pt = /ms/,
              Et = /s|\./;
          return (e.tram = t);
      })(window.jQuery);
          ...
          var t = {},
              ...
              q = (e.each = e.forEach = function (I, x, D) {
                  ...
                  if (E && I.forEach === E) I.forEach(x, D);
                      ...
                      for (var X = 0, $ = I.length; X < $; X++) if (x.call(D, I[X], X, I) === t) return;
                  } else for (var te = e.keys(I), X = 0, $ = te.length; X < $; X++) if (x.call(D, I[te[X]], te[X], I) === t) return;
                  return I;
              });
          ...
          (e.contains = e.include = function (I, x) {
              ...
              (e.debounce = function (I, x, D) {
                  var X,
                      ...
                      j = function () {
                          var U = e.now() - L;
                          U < x ? (X = setTimeout(j, x - U)) : ((X = null), D || ((H = I.apply(te, $)), (te = $ = null)));
                      };
                  return function () {
                      (te = this), ($ = arguments), (L = e.now());
                      var U = D && !X;
                      return X || (X = setTimeout(j, x)), U && ((H = I.apply(te, $)), (te = $ = null)), H;
                  };
              }),
...
` +
  ...
  var $e = u((bW, Ns) => {
      ...
      function bs(e) {
          ve.env() && (ot(e.design) && Ye.on("__wf_design", e.design), ot(e.preview) && Ye.on("__wf_preview", e.preview)), ot(e.destroy) && Ye.on("__wf_destroy", e.destroy), e.ready && ot(e.ready) && _I(e);
      }
      function _I(e) {
          if (un) {
              e.ready();
      ...
      function As(e) {
          ot(e.design) && Ye.off("__wf_design", e.design), ot(e.preview) && Ye.off("__wf_preview", e.preview), ot(e.destroy) && Ye.off("__wf_destroy", e.destroy), e.ready && ot(e.ready) && yI(e);
      }
      function yI(e) {
      ...
      var sn = navigator.userAgent.toLowerCase(),
          ...
          II = (ve.env.chrome = /chrome/.test(sn) && /Google/.test(navigator.vendor) && parseInt(sn.match(/chrome\/(\d+)\./)[1], 10)),
      ...
      ve.destroy = function (e) {
          (e = e || {}), (Ui = !0), Ye.triggerHandler("__wf_destroy"), e.domready != null && (un = e.domready), ze.each(kt, As), ve.resize.off(), ve.scroll.off(), ve.redraw.off(), (Kt = []), (Xi = []), Lt.state() === "pending" && Cs();
      };
      mt(ve.ready);
      Cs();
          ...
          (Ps.exports = function (e) {
              ...
              function p() {
                  var g = e('<a class="w-webflow-badge"></a>').attr("href", "https://webflow.com?utm_campaign=brandjs"),
                      S = e("<img>").attr("src", "https://d3e54v103j8qbb.cloudfront.net/img/webflow-badge-icon.f67cd735e3.svg").attr("alt", "").css({ marginRight: "8px", width: "16px" }),
  ...
  var Ms = u((wW, xs) => {
      ...
      Wi.define(
          ...
          (xs.exports = function (e, t, r) {
              if (((r = r || {}), (Wi.env("test") || Wi.env("frame")) && !r.fixture && !SI())) return { exit: 1 };
              var n = {},
                  o = e(window),
              ...
              function h() {
                  (c = !0),
                      ...
                      o.off(s, p),
                      w(function (N) {
                          e.ajax({ url: A("https://editor-api.webflow.com/api/editor/view"), data: { siteId: i.attr("data-wf-site") }, xhrFields: { withCredentials: !0 }, dataType: "json", crossDomain: !0, success: g(N) });
                      });
              }
              function g(N) {
                  return function (C) {
  ...
  var Bs = u((NW, Ws) => {
      ...
      var Bi = window.jQuery,
          ...
          ln = {
              ...
              intro: function (e, t) {
                  t.__wf_intro || ((t.__wf_intro = !0), Bi(t).triggerHandler(at.types.INTRO));
              },
              outro: function (e, t) {
                  t.__wf_intro && ((t.__wf_intro = null), Bi(t).triggerHandler(at.types.OUTRO));
              },
          };
      at.triggers = {};
  ...
  var xt = u((LW, Sr) => {
      ...
      function CI(e, t) {
          ...
          if (e === null || (RI(e) !== "object" && typeof e != "function")) return { default: e };
          var r = zs(t);
      ...
      (Sr.exports = CI), (Sr.exports.__esModule = !0), (Sr.exports.default = Sr.exports);
  });
  var Qe = u((xW, br) => {
      function NI(e) {
          return e && e.__esModule ? e : { default: e };
      }
      (br.exports = NI), (br.exports.__esModule = !0), (br.exports.default = br.exports);
  });
  var Ie = u((MW, Ys) => {
      var dn = function (e) {
  ...
  var Au = u((QW, bu) => {
      var Su = Ie(),
          ...
          Je,
          vn;
      Ou && ((Je = Ou.split(".")), (vn = Je[0] > 0 && Je[0] < 4 ? 1 : +(Je[0] + Je[1])));
      !vn && Ji && ((Je = Ji.match(/Edge\/(\d+)/)), (!Je || Je[1] >= 74) && ((Je = Ji.match(/Chrome\/(\d+)/)), Je && (vn = +Je[1])));
      bu.exports = vn;
  });
  var eo = u((ZW, Ru) => {
      var wu = Au(),
  ...
  var ao = u((uB, ku) => {
      ...
      })("versions", []).push({ version: "3.19.0", mode: gm ? "pure" : "global", copyright: "\xA9 2021 Denis Pushkarev (zloirock.ru)" });
  });
  var zu = u((cB, Ku) => {
      var _m = Ie(),
          ym = Qi(),
  ...
  var uo = u((dB, tc) => {
      ...
      tc.exports = function (e) {
          if (!Qu($t, e) || !(Zu || typeof $t[e] == "string")) {
              var t = "Symbol." + e;
              Zu && Qu(Dt, e) ? ($t[e] = Dt[e]) : ec && Ju ? ($t[e] = Ju(t)) : ($t[e] = qm(t));
          }
          return $t[e];
      };
  });
  var oc = u((pB, ic) => {
      ...
      ic.exports = function (e, t) {
          ...
          var r = xm(e, Gm),
              n;
          if (r) {
              if ((t === void 0 && (t = "default"), (n = Lm(r, e, t)), !rc(n) || nc(n))) return n;
  ...
  var Nc = u((bB, Cc) => {
      var yT = mc(),
          ...
          AT = function (e) {
              return function (t) {
                  var r;
                  if (!IT(t) || (r = qr(t)).type !== e) throw To("Incompatible receiver, " + e + " required");
                  return r;
              };
          };
      yT || Io.state
  ...
  var ul = u((UB, sl) => {
      ...
      sl.exports = function (e, t) {
          var r = e.target,
              ...
              f,
              E;
          if ((n ? (a = Co) : o ? (a = Co[r] || OO(r, {})) : (a = (Co[r] || {}).prototype), a))
              for (s in t) {
                  if (((f = t[s]), e.noTargetGet ? ((E = IO(a, s)), (c = E && E.value)) : (c = a[s]), (i = bO(n ? s : r + (o ? "." : "#") + s, e.forced)), !i && c !== void 0)) {
  ...
  var dl = u((WB, fl) => {
      ...
      fl.exports = RO
          ...
          : function (t, r) {
                NO(t);
                for (var n = qO(r), o = PO(r), i = o.length, a = 0, s; i > a; ) CO.f(t, (s = o[a++]), n[s]);
                return t;
            };
  });
  var vl = u((BB, pl) => {
  ...
  var Tl = u((HB, ml) => {
      var xO = Cr(),
          ...
          UO = function () {
              var e = GO("iframe"),
                  t = "java" + Po + ":",
                  r;
              return (e.style.display = "none"), FO.appendChild(e), (e.src = String(t)), (r = e.contentWindow.document), r.open(), r.write(Il("document.F=Object")), r.close(), r.F;
          },
          Tn,
          On = function () {
              try {
              ...
              On = typeof document < "u" ? (document.domain && Tn ? _l(Tn) : UO()) : _l(Tn);
      ...
      ml.exports =
          ...
          function (t, r) {
              var n;
              return t !== null ? ((No[qo] = xO(t)), (n = new No()), (No[qo] = null), (n[yl] = t)) : (n = On()), r === void 0 ? n : MO(n, r);
          };
  });
  var Sl = u((jB, Ol) => {
      var VO = uo(),
  ...
  var St = u((nH, jl) => {
      ...
      function vS(e) {
          return e == null ? (e === void 0 ? pS : dS) : Hl && Hl in Object(e) ? lS(e) : fS(e);
      }
      jl.exports = vS;
  });
  var Do = u((iH, kl) => {
  ...
  var Zl = u((Vo, Uo) => {
      ...
      var Zt;
      typeof self < "u" ? (Zt = self) : typeof window < "u" ? (Zt = window) : typeof global < "u" ? (Zt = global) : typeof Uo < "u" ? (Zt = Uo) : (Zt = Function("return this")());
  ...
  var Wo = u((xr) => {
      ...
      function rf(e, t, r) {
          ...
          function h(b) {
              if (!(0, xS.default)(b)) throw new Error("Actions must be plain objects. Use custom middleware for async actions.");
          ...
          return h({ type: ef.INIT }), (n = { dispatch: h, subscribe: p, getState: E, replaceReducer: g }), (n[Jl.default] = S), n;
      }
  });
  var Ho = u((Bo) => {
      "use strict";
  ...
  var lf = u((Ce) => {
      ...
      var lb = { CHILDREN: "CHILDREN", SIBLINGS: "SIBLINGS", IMMEDIATE_CHILDREN: "IMMEDIATE_CHILDREN" };
  ...
  var Qo = u((er) => {
      ...
      var vb = { ELEMENT: "ELEMENT", ELEMENT_CLASS: "ELEMENT_CLASS", TRIGGER_ELEMENT: "TRIGGER_ELEMENT" };
  ...
  var df = u((bn) => {
      ...
      var hb = Qo(),
          { TRANSFORM_MOVE: gb, TRANSFORM_SCALE: _b, TRANSFORM_ROTATE: yb, TRANSFORM_SKEW: Ib, STYLE_SIZE: mb, STYLE_FILTER: Tb, STYLE_FONT_VARIATION: Ob } = hb.ActionTypeConsts,
          Sb = { [gb]: !0, [_b]: !0, [yb]: !0, [Ib]: !0, [mb]: !0, [Tb]: !0, [Ob]: !0 };
  ...
  var rr = u((Te) => {
              ...
              if (f != null) {
                  ...
                  if (E.length)
                      for (var p = 0; p <= E.length; p++) {
                          ...
                          if (!(e && n[h] !== void 0)) {
                              var g = f[h];
                              t && Rn(n[h]) && Rn(g) && (g = We(e, t, n[h], g)), !(g === void 0 || g === n[h]) && (o || ((o = !0), (n = Cn(n))), (n[h] = g));
                          }
                      }
              }
          }
      ...
      function Cf(e, t, r, n, o, i) {
          ...
          return s.length ? We.call.apply(We, [null, !1, !1, e, t, r, n, o, i].concat(s)) : We(!1, !1, e, t, r, n, o, i);
      }
      function Nf(e, t, r, n, o, i) {
          for (var a = arguments.length, s = Array(a > 6 ? a - 6 : 0), c = 6; c < a; c++) s[c - 6] = arguments[c];
          return s.length ? We.call.apply(We, [null, !1, !0, e, t, r, n, o, i].concat(s)) : We(!1, !0, e, t, r, n, o, i);
      }
      function qf(e, t, r, n, o, i, a) {
          var s = Nn(e, t);
          s == null && (s = {});
          for (var c = void 0, f = arguments.length, E = Array(f > 7 ? f - 7 : 0), p = 7; p < f; p++) E[p - 7] = arguments[p];
          return E.length ? (c = We.call.apply(We, [null, !1, !1, s, r, n, o, i, a].concat(E))) : (c = We(!1, !1, s, r, n, o, i, a)), Pn(e, t, c);
      }
      function Pf(e, t) {
      ...
      function Lf(e, t, r, n, o, i) {
          for (var a = arguments.length, s = Array(a > 6 ? a - 6 : 0), c = 6; c < a; c++) s[c - 6] = arguments[c];
          return s.length ? We.call.apply(We, [null, !0, !1, e, t, r, n, o, i].concat(s)) : We(!0, !1, e, t, r, n, o, i);
      }
      var e0 = {
          clone: Cn,
          addLast: yf,
  ...
  var Mf = u((Ln) => {
      ...
      var r0 = t0(tr()),
          n0 = Ve(),
          i0 = rr(),
          { IX2_PREVIEW_REQUESTED: o0, IX2_PLAYBACK_REQUESTED: a0, IX2_STOP_REQUESTED: s0, IX2_CLEAR_REQUESTED: u0 } = n0.IX2EngineActionTypes,
          c0 = { preview: {}, playback: {}, stop: {}, clear: {} },
          xf = Object.create(null, { [o0]: { value: "preview" }, [a0]: { value: "playback" }, [s0]: { value: "stop" }, [u0]: { value: "clear" } }),
          l0 = (e = c0, t) => {
              if (t.type in xf) {
                  let r = [xf[t.type]];
  ...
  var Ff = u((xn) => {
      ...
      var f0 = Ve(),
          ...
          Df = { active: !1, tick: 0, eventListeners: [], eventState: {}, playbackState: {}, viewportWidth: 0, mediaQueryKey: null, hasBoundaryNodes: !1, hasDefinedMediaQueries: !1, reducedMotion: !1 },
          T0 = 20,
          O0 = (e = Df, t) => {
              switch (t.type) {
                  case d0: {
  ...
  var Nd = u((nj, Cd) => {
      ...
      function Ww(e, t) {
          var r = this.__data__;
          return (this.size += this.has(e) ? 0 : 1), (r[e] = Uw && t === void 0 ? Vw : t), this;
      }
      Cd.exports = Ww;
  });
  var Pd = u((ij, qd) => {
  ...
  var Md = u((oj, xd) => {
      var Ld = Pd(),
          ...
          Yw = Dn();
      function $w() {
          (this.size = 0), (this.__data__ = { hash: new Ld(), map: new (Yw || zw)(), string: new Ld() });
      }
      xd.exports = $w;
  });
  var Fd = u((aj, Dd) => {
  ...
  var Yd = u((pj, zd) => {
      ...
      function gR(e, t) {
          ...
          if (r instanceof pR) {
              var n = r.__data__;
              if (!vR || n.length < hR - 1) return n.push([e, t]), (this.size = ++r.size), this;
  ...
  var Vn = u((Mj, Xp) => {
      ...
      function MC(e, t) {
          var r = typeof e;
          return (t = t ?? LC), !!t && (r == "number" || (r != "symbol" && xC.test(e))) && e > -1 && e % 1 == 0 && e < t;
      }
      Xp.exports = MC;
  });
  var Wn = u((Dj, Up) => {
  ...
  var Wp = u((Fj, Vp) => {
      var GC = St(),
          ...
          ye = {};
      ye[rN] = ye[nN] = ye[iN] = ye[oN] = ye[aN] = ye[sN] = ye[uN] = ye[cN] = ye[lN] = !0;
      ye[VC] = ye[WC] = ye[eN] = ye[BC] = ye[tN] = ye[HC] = ye[jC] = ye[kC] = ye[KC] = ye[zC] = ye[YC] = ye[$C] = ye[QC] = ye[ZC] = ye[JC] = !1;
      function fN(e) {
  ...
  var va = u((Uj, $p) => {
      ...
      function wN(e, t) {
          var r = mN(e),
              ...
              c = s.length;
          for (var f in e) (t || AN.call(e, f)) && !(a && (f == "length" || (o && (f == "offset" || f == "parent")) || (i && (f == "buffer" || f == "byteLength" || f == "byteOffset")) || ON(f, c))) && s.push(f);
          return s;
      }
      $p.exports = wN;
  });
  ...
  var kn = u((Zj, mv) => {
      var ha = cv(),
          ...
          Eq = cr(Ia),
          Xt = Iv;
      ((ha && Xt(new ha(new ArrayBuffer(1))) != yv) || (ga && Xt(new ga()) != Ev) || (_a && Xt(_a.resolve()) != hv) || (ya && Xt(new ya()) != gv) || (Ia && Xt(new Ia()) != _v)) &&
          (Xt = function (e) {
              var t = Iv(e),
  ...
  var Cv = u((Jj, Rv) => {
      ...
      function Tq(e, t, r, n, o, i) {
          ...
          if (h && !E) return i || (i = new ma()), a || yq(e) ? hq(e, t, r, n, o, i) : gq(e, t, c, r, n, o, i);
          if (!(r & Iq)) {
  ...
  var Ta = u((e5, Pv) => {
      ...
      function qv(e, t, r, n, o) {
          return e === t ? !0 : e == null || t == null || (!Nv(e) && !Nv(t)) ? e !== e && t !== t : Oq(e, t, r, n, qv, o);
      }
      Pv.exports = qv;
  });
  var xv = u((t5, Lv) => {
  ...
  var zn = u((s5, Wv) => {
      ...
      function Kq(e, t) {
          if (Bq(e)) return !1;
          var r = typeof e;
          return r == "number" || r == "symbol" || r == "boolean" || e == null || Hq(e) ? !0 : kq.test(e) || !jq.test(e) || (t != null && e in Object(t));
      }
      Wv.exports = Kq;
  });
  var jv = u((u5, Hv) => {
      ...
      function ba(e, t) {
          if (typeof e != "function" || (t != null && typeof t != "function")) throw new TypeError(zq);
          var r = function () {
              var n = arguments,
  ...
  var dE = u((y5, fE) => {
      ...
      function CP(e, t, r) {
          ...
          return i || ++n != o ? i : ((o = e == null ? 0 : e.length), !!o && wP(o) && AP(a, o) && (bP(e) || SP(e)));
      }
      fE.exports = CP;
  });
  var vE = u((I5, pE) => {
  ...
  var At = u((A5, OE) => {
      var ZP = Uv(),
          ...
          rL = TE();
      function nL(e) {
          return typeof e == "function" ? e : e == null ? eL : typeof e == "object" ? (tL(e) ? JP(e[0], e[1]) : ZP(e)) : rL(e);
      }
      OE.exports = nL;
  });
  var Ra = u((w5, SE) => {
  ...
  var ei = u((Fe) => {
      ...
      var Jn = (e, t) => (VE ? e() : t);
      Fe.withBrowser = Jn;
      var DL = Jn(() => (0, ML.default)(["matches", "matchesSelector", "mozMatchesSelector", "msMatchesSelector", "oMatchesSelector", "webkitMatchesSelector"], (e) => e in Element.prototype));
  ...
  var Pa = u((F5, KE) => {
      ...
      function HL(e, t, r, n, o) {
          var i,
              a,
              s = 0;
          do (a = t + (r - t) / 2), (i = ri(a, n, o) - e), i > 0 ? (r = a) : (t = a);
      ...
      KE.exports = function (t, r, n, o) {
          ...
          if (t !== r || n !== o) for (var a = 0; a < kr; ++a) i[a] = ri(a * ti, t, n);
          function s(c) {
  ...
  var Ma = u((Kr) => {
      ...
      function xx(e, t, r) {
          return t === 0 ? 0 : t === 1 ? 1 : xa(r ? (t > 0 ? r(t) : t) : t > 0 && e && zE[e] ? zE[e](t) : t);
      }
  });
  var ZE = u((fr) => {
      "use strict";
      ...
      var ii = rr(),
          ...
          { IX2_SESSION_STOPPED: Hx, IX2_INSTANCE_ADDED: jx, IX2_ELEMENT_STATE_CHANGED: kx } = $E.IX2EngineActionTypes,
          YE = {},
          Kx = "refState",
          zx = (e = YE, t = {}) => {
              switch (t.type) {
                  ...
                  case jx: {
                      let { elementId: r, element: n, origin: o, actionItem: i, refType: a } = t.payload,
                          { actionTypeId: s } = i,
                          c = e;
                      return (0, ii.getIn)(c, [r, n]) !== n && (c = QE(c, n, a, r, i)), Da(c, r, s, o, i);
                  }
                  case kx: {
      ...
      function QE(e, t, r, n, o) {
          let i = r === Mx ? (0, ii.getIn)(o, ["config", "target", "objectId"]) : null;
  ...
  var Sh = u((rk, Oh) => {
      ...
      function ZM(e, t, r) {
          ...
          if (!n) return -1;
          var o = n - 1;
          return r !== void 0 && ((o = YM(r)), (o = r < 0 ? $M(n + o, 0) : QM(o, n - 1))), KM(e, zM(t, 3), o, !0);
      }
      Oh.exports = ZM;
  });
  var Ah = u((nk, bh) => {
  ...
  var Rh = u((ai) => {
      ...
      function nD(e, t) {
          ...
          for (let o = 0; o < r.length; o++) if (!rD.call(t, r[o]) || !wh(e[r[o]], t[r[o]])) return !1;
          return !0;
      }
      var iD = nD;
      ai.default = iD;
  ...
  var Kh = u((Ee) => {
      ...
      var wt = li(uh()),
          ...
          Wh = Object.freeze({ [Ge.TRANSFORM_PREFIXED]: sD, [Fh]: aD, [ui]: ui, [zr]: zr, [lt]: lt, [ft]: ft, [Yr]: Yr }),
          si = new Map();
      function TD() {
          si.clear();
      }
      ...
      function ka({ config: e, event: t, eventTarget: r, elementRoot: n, elementApi: o }) {
          ...
          let { targets: c } = e;
          if (Array.isArray(c) && c.length > 0) return c.reduce((D, X) => D.concat(ka({ config: { target: X }, event: t, eventTarget: r, elementRoot: n, elementApi: o })), []);
          let { getValidDocument: f, getQuerySelector: E, queryDocument: p, getChildElements: h, getSiblingElements: g, matchSelector: S, elementContains: b, isSiblingNode: P } = o,
              { target: A } = e;
          if (!A) return [];
          let { id: w, objectId: m, selector: N, selectorGuids: C, appliesTo: q, useEventTarget: G } = Ph(A);
          ...
          let Y = ((i = t == null || (a = t.action) === null || a === void 0 || (s = a.config) === null || s === void 0 ? void 0 : s.affectedElements) !== null && i !== void 0 ? i : {})[w || N] || {},
              ...
              I,
              x = t && E(Ph(t.target));
          if ((ie ? ((ee = Y.limitAffectedElements), (M = x), (I = E(Y))) : (M = I = E({ id: w, selector: N, selectorGuids: C })), t && G)) {
              let D = r && (I || G === !0) ? [r] : p(x);
              if (I) {
          ...
          return M == null || I == null ? [] : Ge.IS_BROWSER_ENV && n ? p(I).filter((D) => n.contains(D)) : ee === Nh ? p(M, I) : ee === _D ? h(p(M)).filter(S(I)) : ee === qh ? g(p(M)).filter(S(I)) : p(I);
      }
      ...
      var Lh = /px/,
          qD = (e, t) => t.reduce((r, n) => (r[n.type] == null && (r[n.type] = UD[n.type]), r), e || {}),
          PD = (e, t) => t.reduce((r, n) => (r[n.type] == null && (r[n.type] = VD[n.type] || n.defaultValue || 0), r), e || {});
          ...
          switch (n.actionTypeId) {
              ...
              case hr: {
                  let s = i(e, lt),
                      ...
                      E;
                  return (
                      n.config.widthUnit === Rt ? (f = Lh.test(s) ? parseFloat(s) : parseFloat(r.width)) : (f = (0, wt.default)(parseFloat(s), parseFloat(r.width))),
                      n.config.heightUnit === Rt ? (E = Lh.test(c) ? parseFloat(c) : parseFloat(r.height)) : (E = (0, wt.default)(parseFloat(c), parseFloat(r.height))),
              ...
              case _r:
              case yr:
                  return ZD({ element: e, actionTypeId: n.actionTypeId, computedStyle: r, getStyle: i });
              case fi:
      ...
      var Ka = {
          ...
          UD = Object.freeze({ blur: 0, "hue-rotate": 0, invert: 0, grayscale: 0, saturate: 100, sepia: 0, contrast: 100, brightness: 100 }),
      ...
      function HD(e, t, r, n, o) {
          let i = BD.map((s) => {
                  let c = Ka[s],
                      { xValue: f = c.xValue, yValue: E = c.yValue, zValue: p = c.zValue, xUnit: h = "", yUnit: g = "", zUnit: S = "" } = t[s] || {};
                  switch (s) {
                      case pr:
              ...
              { setStyle: a } = o;
          Wt(e, Ge.TRANSFORM_PREFIXED, o), a(e, Ge.TRANSFORM_PREFIXED, i), KD(n, r) && a(e, Ge.TRANSFORM_STYLE_PREFIXED, vD);
      }
      function jD(e, t, r, n) {
      ...
      function ZD({ element: e, actionTypeId: t, computedStyle: r, getStyle: n }) {
          let o = ja[t],
              i = n(e, o),
              a = YD.test(i) ? i : r[o],
              s = QD($D, a).split($r);
          return { rValue: (0, wt.default)(parseInt(s[0], 10), 255), gValue: (0, wt.default)(parseInt(s[1], 10), 255), bValue: (0, wt.default)(parseInt(s[2], 10), 255), aValue: (0, wt.default)(parseFloat(s[3]), 1) };
      }
      function JD(e, t, r, n, o, i) {
          ...
          switch (n.actionTypeId) {
              case hr: {
                  ...
                  f !== void 0 && (s === Rt && (s = "px"), Wt(e, lt, i), a(e, lt, f + s)), E !== void 0 && (c === Rt && (c = "px"), Wt(e, ft, i), a(e, ft, E + c));
                  break;
              }
              case Zr: {
                  jD(e, r, n.config, i);
              ...
              case yr: {
                  let s = ja[n.actionTypeId],
                      ...
                      p = r.aValue;
                  Wt(e, s, i), a(e, s, p >= 1 ? `rgb(${c},${f},${E})` : `rgba(${c},${f},${E},${p})`);
                  break;
              }
              default: {
                  let { unit: s = "" } = n.config;
      ...
      function eF(e, t, r) {
          ...
          switch (t.actionTypeId) {
              case fi: {
                  ...
                  o === ED && Ge.IS_BROWSER_ENV ? n(e, ci, Ge.FLEX_PREFIXED) : n(e, ci, o);
                  return;
              }
          }
      }
      ...
      function Mh({ actionGroup: e, event: t, elementApi: r }) {
          ...
          n.forEach(({ actionTypeId: o, config: i }) => {
              let a;
              (0, dt.isPluginType)(o) ? (a = (0, dt.clearPlugin)(o)) : (a = jh({ effect: nF, actionTypeId: o, elementApi: r })), ka({ config: i, event: t, elementApi: r }).forEach(a);
          });
      }
      function rF(e, t, r) {
      ...
      var jh = ({ effect: e, actionTypeId: t, elementApi: r }) => (n) => {
          switch (t) {
              case pr:
              case vr:
              case Er:
      ...
      function nF(e, t, r) {
          let { setStyle: n } = r;
          Hh(e, t, r), n(e, t, ""), t === Ge.TRANSFORM_PREFIXED && n(e, Ge.TRANSFORM_STYLE_PREFIXED, "");
      }
      function kh(e) {
          let t = 0,
              r = 0;
      ...
      function oF({ actionList: e, actionItemId: t, rawData: r }) {
          let { actionItemGroups: n, continuousParameterGroups: o } = e,
              i = [],
              a = (s) => (i.push((0, Ch.mergeIn)(s, ["config"], { delay: 0, duration: 0 })), s.id === t);
          return (
              ...
              (0, Ch.setIn)(r, ["actionLists"], { [e.id]: { id: e.id, actionItemGroups: [{ actionItems: i }] } })
          );
      }
  ...
  var Qh = u((pi) => {
      ...
      var zh = Ve(),
          Yh = Bt(),
          mr = rr(),
          { IX2_RAW_DATA_IMPORTED: gF, IX2_SESSION_STOPPED: _F, IX2_INSTANCE_ADDED: yF, IX2_INSTANCE_STARTED: IF, IX2_INSTANCE_REMOVED: mF, IX2_ANIMATION_FRAME_CHANGED: TF } = zh.IX2EngineActionTypes,
          { optimizeFloat: di, applyEasing: $h, createBezierEasing: OF } = Yh.IX2EasingUtils,
          { RENDER_GENERAL: SF } = zh.IX2EngineConstants,
          { getItemConfigByKey: za, getRenderType: bF, getStyleProp: AF } = Yh.IX2VanillaUtils,
          wF = (e, t) => {
              let { position: r, parameterId: n, actionGroups: o, destinationKeys: i, smoothing: a, restingValue: s, actionTypeId: c, customEasingFn: f, skipMotion: E, skipToValue: p } = e,
              ...
              for (let k = 0, { length: Y } = o; k < Y; k++) {
                  ...
                  if ((k === 0 && (m = ee[0]), w >= ie)) {
                      ...
                      let M = o[k + 1],
                          I = M && w !== ie;
                      (N = I ? M.actionItems[0] : null), I && ((C = ie / 100), (q = (M.keyframe - ie) / 100));
                  }
              }
              let G = {};
              if (m && !N)
          ...
          RF = (e, t) => {
              let { active: r, origin: n, start: o, immediate: i, renderType: a, verbose: s, actionItem: c, destination: f, destinationKeys: E, pluginDuration: p, instanceDelay: h, customEasingFn: g, skipMotion: S } = e,
                  b = c.config.easing,
                  { duration: P, delay: A } = c.config;
              p != null && (P = p), (A = h ?? A), a === SF ? (P = 0) : (i || S) && (P = A = 0);
              let { now: w } = t.payload;
              if (r && n) {
                  let m = w - (o + A);
                  if (s) {
  ...
  var Zh = u((vi) => {
      ...
      var NF = Ve(),
          { IX2_RAW_DATA_IMPORTED: qF, IX2_SESSION_STOPPED: PF, IX2_PARAMETER_CHANGED: LF } = NF.IX2EngineActionTypes,
          xF = (e = {}, t) => {
              switch (t.type) {
                  case qF:
  ...
  var Jh = u((Ei) => {
      ...
      var MF = $o(),
          ...
          BF = (0, MF.combineReducers)({ ixData: DF.ixData, ixRequest: FF.ixRequest, ixSession: GF.ixSession, ixElements: WF, ixInstances: UF.ixInstances, ixParameters: VF.ixParameters });
      Ei.default = BF;
  });
  var eg = u((lk, en) => {
      function HF(e, t) {
      ...
      (en.exports = HF), (en.exports.__esModule = !0), (en.exports.default = en.exports);
  });
  var rg = u((fk, tg) => {
      var jF = St(),
          kF = Ne(),
  ...
  var Za = u((yk, Sg) => {
      var Og = Qa();
      function M1(e, t, r) {
          t == "__proto__" && Og ? Og(e, t, { configurable: !0, enumerable: !0, value: r, writable: !0 }) : (e[t] = r);
      }
      Sg.exports = M1;
  });
  var Ag = u((Ik, bg) => {
      ...
      function U1(e, t, r) {
          var n = e[t];
          (!(X1.call(e, t) && F1(n, r)) || (r === void 0 && !(t in e))) && D1(e, t, r);
      }
      bg.exports = U1;
  });
  var Cg = u((mk, Rg) => {
      ...
      function j1(e, t, r, n) {
          ...
          for (var o = -1, i = t.length, a = i - 1, s = e; s != null && ++o < i; ) {
              ...
              if (o != a) {
                  var E = s[c];
                  (f = n ? n(E, c, s) : void 0), f === void 0 && (f = wg(E) ? E : B1(t[o + 1]) ? [] : {});
              }
              V1(s, c, f), (s = s[c]);
          }
          return e;
  ...
  var Kg = u((Nk, kg) => {
      ...
      function G2(e) {
          if (e == null) return !0;
          if (N2(e) && (C2(e) || typeof e == "string" || typeof e.splice == "function" || q2(e) || L2(e) || R2(e))) return !e.length;
          var t = w2(e);
  ...
  var a_ = u((Dk, o_) => {
      ...
      function nG(e, t, r) {
          ...
          (t = i_(t) || 0), J2(r) && ((E = !!r.leading), (p = "maxWait" in r), (i = p ? tG(i_(r.maxWait) || 0, t) : i), (h = "trailing" in r ? !!r.trailing : h));
          function g(q) {
              var G = n,
                  k = o;
  ...
  var u_ = u((Fk, s_) => {
      ...
      function sG(e, t, r) {
          ...
          return oG(r) && ((n = "leading" in r ? !!r.leading : n), (o = "trailing" in r ? !!r.trailing : o)), iG(e, t, { leading: n, maxWait: t, trailing: o });
      }
      s_.exports = sG;
  });
  var hi = u((ae) => {
      ...
      var PG = ({ hasBoundaryNodes: e, reducedMotion: t }) => ({ type: fG, payload: { hasBoundaryNodes: e, reducedMotion: t } });
      ae.sessionInitialized = PG;
      var LG = () => ({ type: dG });
      ae.sessionStarted = LG;
      var xG = () => ({ type: pG });
      ae.sessionStopped = xG;
      var MG = ({ rawData: e, defer: t }) => ({ type: vG, payload: { defer: t, rawData: e } });
      ae.previewRequested = MG;
      var DG = ({ actionTypeId: e = l_.ActionTypeConsts.GENERAL_START_ACTION, actionListId: t, actionItemId: r, eventId: n, allowEvents: o, immediate: i, testManual: a, verbose: s, rawData: c }) => ({
          type: EG,
      ...
      var XG = (e, t) => ({ type: _G, payload: { target: e, listenerParams: t } });
      ...
      var KG = (e, t, r, n) => ({ type: AG, payload: { elementId: e, actionTypeId: t, current: r, actionItem: n } });
      ae.elementStateChanged = KG;
      var zG = ({ actionListId: e, isPlaying: t }) => ({ type: wG, payload: { actionListId: e, isPlaying: t } });
      ae.actionListPlaybackChanged = zG;
      var YG = ({ width: e, mediaQueries: t }) => ({ type: RG, payload: { width: e, mediaQueries: t } });
  ...
  var p_ = u((Le) => {
      ...
      function oX({ id: e, selector: t }) {
          if (e) {
              ...
              if (e.indexOf(f_) !== -1) {
                  let n = e.split(f_),
                      o = n[0];
                  if (((r = n[1]), o !== document.documentElement.getAttribute(d_))) return null;
              }
      ...
      function pX(e) {
          return e != null && typeof e == "object" ? (e instanceof Element ? JG : eX) : null;
      }
  });
  var ts = u((Uk, E_) => {
      var vX = ct(),
  ...
  var S_ = u((Hk, O_) => {
      ...
      function T_(e, t, r, n, o) {
          ...
          for (r || (r = OX), o || (o = []); ++i < a; ) {
              var s = e[i];
              t > 0 && r(s) ? (t > 1 ? T_(s, t - 1, r, n, o) : TX(o, s)) : n || (o[o.length] = s);
          }
          return o;
      }
      O_.exports = T_;
  ...
  var q_ = u((Kk, N_) => {
      ...
      function RX(e, t, r) {
          return (
              ...
              function () {
                  for (var n = arguments, o = -1, i = C_(n.length - t, 0), a = Array(i); ++o < i; ) a[o] = n[t + o];
                  o = -1;
  ...
  var D_ = u((Yk, M_) => {
      var NX = L_(),
          ...
          PX = x_
              ? function (e, t) {
                    return x_(e, "toString", { configurable: !0, enumerable: !1, value: NX(t), writable: !0 });
                }
              : qX;
      M_.exports = PX;
  });
  ...
  var ns = u((nK, J_) => {
      var Z_ = Q_(),
          ...
          $X = YX.hasOwnProperty;
      function QX(e) {
          for (var t = e.name + "", r = Z_[t], n = $X.call(Z_, t) ? r.length : 0; n--; ) {
              var o = r[n],
                  i = o.func;
  ...
  var mi = u((iK, ey) => {
      var ZX = ts(),
          ...
          eU = 4294967295;
      function Ii(e) {
          (this.__wrapped__ = e), (this.__actions__ = []), (this.__dir__ = 1), (this.__filtered__ = !1), (this.__iteratees__ = []), (this.__takeCount__ = eU), (this.__views__ = []);
      }
      ...
      function AU(e) {
          return _U(function (t) {
              ...
              for (n = a ? n : r; ++n < r; ) {
                  ...
                  c && fy(c[0]) && c[1] == (SU | TU | OU | bU) && !c[4].length && c[9] == 1 ? (a = a[is(c[0])].apply(a, c[3])) : (a = i.length == 1 && fy(i) ? a[s]() : a.thru(i));
              }
              return function () {
                  var f = arguments,
                      E = f[0];
  ...
  var yy = u((dK, _y) => {
      var NU = gy(),
          os = Zn();
      function qU(e, t, r) {
          return r === void 0 && ((r = t), (t = void 0)), r !== void 0 && ((r = os(r)), (r = r === r ? r : 0)), t !== void 0 && ((t = os(t)), (t = t === t ? t : 0)), NU(os(e), t, r);
      }
      _y.exports = qU;
  });
  var Fy = u((wi) => {
      ...
      var je = Ai(tr()),
          ...
          Be = ({ store: e, event: t, element: r, eventStateKey: n }, o) => {
              let { action: i, id: a } = t,
                  ...
                  f = xy(e, c);
              return (
                  f && (0, as.stopActionGroup)({ store: e, eventId: c, eventTarget: r, eventStateKey: c + Iy + n.split(Iy)[1], actionListId: (0, LU.default)(f, "action.config.actionListId") }),
          ...
          tn = (() => {
              ...
              return () => ({
                  ...
                  stiffScrollTop: (0, xU.default)(e ? window.pageYOffset : r.scrollTop, 0, r.scrollHeight - window.innerHeight),
          ...
          aV = (e, t) => !(e.left > t.right || e.right < t.left || e.top > t.bottom || e.bottom < t.top),
          ...
          uV = (e) => {
              ...
              return aV(t.getBoundingClientRect(), { left: 0, top: c, right: n, bottom: o - c });
          },
          Dy = (e) => (t, r) => {
          ...
          Sy = (e) => (t, r = {}) => {
              ...
              let g = (E ? c : (i * (c || 0)) / 100) / p,
                  ...
                  b,
                  P = 0;
              r && ((S = h > r.percentTop), (b = r.scrollingDown !== S), (P = b ? h : r.anchorTop));
              let A = s === Ry ? h >= P + g : h <= P - g,
                  w = (0, je.default)({}, r, { percentTop: h, inBounds: A, anchorTop: P, scrollingDown: S });
              return (r && A && (b || w.inBounds !== r.inBounds) && e(t, w)) || w;
          },
          lV = (e, t) => e.left > t.left && e.left < t.right && e.top > t.top && e.top < t.bottom,
          fV = (e) => (t, r) => {
          ...
          Ay = (0, je.default)({}, cs, {
              handler: cV((e, t) => {
                  let { elementVisible: r } = t,
                      ...
                      { ixData: i } = o.getState(),
                      { events: a } = i;
                  return !a[n.action.config.autoStopEventId] && t.triggered ? t : (n.eventTypeId === Cy) === r ? (Be(e), (0, je.default)({}, t, { triggered: !0 })) : t;
              }),
          }),
          wy = 0.05,
          pV = {
              ...
              [$U]: {
                  ...
                  handler: ({ store: e, element: t, eventConfig: r, nativeEvent: n, eventStateKey: o }, i = { clientX: 0, clientY: 0, pageX: 0, pageY: 0 }) => {
                      let { basedOn: a, selectedAxis: s, continuousParameterGroupId: c, reverse: f, restingState: E = 0 } = r,
                          { clientX: p = i.clientX, clientY: h = i.clientY, pageX: g = i.pageX, pageY: S = i.pageY } = n,
                          b = s === "X_AXIS",
                          P = n.type === "mouseout",
                          A = E / 100,
                          w = c,
                      ...
                      return (
                          ...
                          (a !== Ht.EventBasedOn.ELEMENT || m || m !== i.elementHovered) && ((A = f ? 1 - A : A), e.dispatch((0, Oi.parameterChanged)(w, A))),
              ...
              [JU]: {
                  ...
                  handler: ({ element: e, store: t, eventConfig: r, eventStateKey: n }, o = { scrollPercent: 0 }) => {
                      let { scrollLeft: i, scrollTop: a, scrollWidth: s, scrollHeight: c, clientHeight: f } = tn(),
                          { basedOn: E, selectedAxis: p, continuousParameterGroupId: h, startsEntering: g, startsExiting: S, addEndOffset: b, addStartOffset: P, addOffsetValue: A = 0, endOffsetValue: w = 0 } = r,
                          m = p === "X_AXIS";
                      if (E === Ht.EventBasedOn.VIEWPORT) {
                          let N = m ? i / s : a / c;
                          return N !== o.scrollPercent && t.dispatch((0, Oi.parameterChanged)(h, N)), { scrollPercent: N };
                      } else {
                          let N = my(n, h),
                          ...
                          return I !== o.scrollPercent && t.dispatch((0, Oi.parameterChanged)(N, I)), { scrollPercent: I };
                      }
                  },
              },
              [Cy]: Ay,
              ...
              [Ny]: { types: "readystatechange IX2_PAGE_UPDATE", handler: tt(rn, fV(Be)) },
              [qy]: { types: "readystatechange IX2_PAGE_UPDATE", handler: tt(rn, dV(Be)) },
          };
      wi.default = pV;
  });
  var ls = u((Nt) => {
      ...
      var EV = nt(tr()),
          ...
          fs = (e) => bV.includes(e),
          { COLON_DELIMITER: ds, BOUNDARY_SELECTOR: Ri, HTML_ELEMENT: Vy, RENDER_GENERAL: AV, W_MOD_IX: Gy } = rt.IX2EngineConstants,
          {
          ...
          { isPluginType: qi, createPluginInstance: vs, getPluginDuration: VV } = Uy.IX2VanillaPlugins,
          Xy = navigator.userAgent,
          WV = Xy.match(/iPad/i) || Xy.match(/iPhone/),
          BV = 12;
      function HV(e) {
          jt({ store: e, select: ({ ixRequest: t }) => t.preview, onChange: KV }),
              jt({ store: e, select: ({ ixRequest: t }) => t.playback, onChange: zV }),
      ...
      function jV(e) {
          jt({
              ...
              onChange: () => {
                  Li(e), Wy({ store: e, elementApi: we }), Pi({ store: e, allowEvents: !0 }), By();
              },
          });
      }
      function kV(e, t) {
      ...
      function zV(e, t) {
          ...
          if ((Pi({ store: t, rawData: E, allowEvents: a, testManual: c }), (n && r === rt.ActionTypeConsts.GENERAL_START_ACTION) || fs(r))) {
              Es({ store: t, actionListId: n }), jy({ store: t, actionListId: n, eventId: i });
              let p = hs({ store: t, eventId: i, actionListId: n, immediate: s, verbose: f });
      ...
      function Pi({ store: e, rawData: t, allowEvents: r, testManual: n }) {
          ...
          t && e.dispatch((0, Oe.rawDataImported)(t)),
              o.active ||
                  (e.dispatch((0, Oe.sessionInitialized)({ hasBoundaryNodes: !!document.querySelector(Ri), reducedMotion: document.body.hasAttribute("data-wf-ix-vacation") && window.matchMedia("(prefers-reduced-motion)").matches })),
                  r && (rW(e), QV(), e.getState().ixSession.hasDefinedMediaQueries && jV(e)),
      ...
      function eW({ store: e, eventStateKey: t, eventTarget: r, eventId: n, eventConfig: o, actionListId: i, parameterGroup: a, smoothing: s, restingValue: c }) {
          ...
          A.forEach((N) => {
              ...
              q.forEach((G) => {
                  ...
                  if (((b[ee] = tW(b[ee], C, G)), !S[ee])) {
                      S[ee] = !0;
                      let { config: M } = G;
                      Ci({ config: M, event: h, eventTarget: r, elementRoot: ie, elementApi: we }).forEach((I) => {
              ...
              P.forEach(({ element: N, key: C }) => {
                  ...
                  gs({ store: e, element: N, eventId: n, actionListId: i, actionItem: G, destination: ie, continuous: !0, parameterId: w, actionGroups: q, smoothing: s, restingValue: c, pluginInstance: Y });
              });
      }
      function tW(e = [], t, r) {
          let n = [...e],
                  ...
                  S.actionTypeId === rt.ActionTypeConsts.GENERAL_CONTINUOUS_ACTION &&
                      (Array.isArray(g.config) ? g.config : [g.config]).forEach((m) => {
                          ...
                          q &&
                              p.forEach((Y, ie) => {
                                  let ee = b + ds + ie;
                                  eW({ store: t, eventStateKey: ee, eventTarget: Y, eventId: b, eventConfig: m, actionListId: A, parameterGroup: q, smoothing: G, restingValue: k });
                              });
                      }),
                  (S.actionTypeId === rt.ActionTypeConsts.GENERAL_START_ACTION || fs(S.actionTypeId)) && jy({ store: t, actionListId: A, eventId: b });
          });
          let c = (p) => {
                  ...
                  aW(s, (g, S, b) => {
                      ...
                      let N = (C = {}) => {
                          let q = o({ store: t, element: g, event: P, eventConfig: C, nativeEvent: p, eventStateKey: b }, A);
                          UV(q, A) || t.dispatch((0, Oe.eventStateChanged)(b, q));
                      };
                      w.actionTypeId === rt.ActionTypeConsts.GENERAL_CONTINUOUS_ACTION ? (Array.isArray(P.config) ? P.config : [P.config]).forEach(N) : N();
                  });
              },
              f = (0, TV.default)(c, BV),
          ...
          if (c && c.useFirstGroupAsInitialState) {
              ...
              f.forEach((p) => {
                  ...
                  let { config: g, actionTypeId: S } = p,
                      b = (g == null || (h = g.target) === null || h === void 0 ? void 0 : h.useEventTarget) === !0 ? { target: s.target, targets: s.targets } : g,
                      P = Ci({ config: b, event: s, elementApi: we }),
                      A = qi(S);
                  P.forEach((w) => {
                      let m = A ? vs(S)(w, p) : null;
                      gs({ destination: ps({ element: w, actionItem: p, elementApi: we }, m), immediate: !0, store: e, element: w, eventId: r, actionItem: p, actionListId: t, pluginInstance: m });
                  });
              });
          }
      }
      function ky({ store: e }) {
          ...
          (0, on.default)(t, (r) => {
              if (!r.continuous) {
                  ...
                  _s(r, e), o && e.dispatch((0, Oe.actionListPlaybackChanged)({ actionListId: n, isPlaying: !1 }));
              }
          });
      }
      function Es({ store: e, eventId: t, eventTarget: r, eventStateKey: n, actionListId: o }) {
          ...
          (0, on.default)(i, (c) => {
              ...
              if (c.actionListId === o && c.eventId === t && E) {
                  ...
                  _s(c, e), c.verbose && e.dispatch((0, Oe.actionListPlaybackChanged)({ actionListId: o, isPlaying: !1 }));
              }
          });
      }
      function hs({ store: e, eventId: t, eventTarget: r, eventStateKey: n, actionListId: o, groupIndex: i = 0, immediate: a, verbose: s }) {
          var c;
          let { ixData: f, ixSession: E } = e.getState(),
              { events: p } = f,
              h = p[t] || {},
          ...
          i >= b.length && (0, Ct.default)(h, "config.loop") && (i = 0), i === 0 && P && i++;
          let w = (i === 0 || (i === 1 && P)) && fs((c = h.action) === null || c === void 0 ? void 0 : c.actionTypeId) ? h.config.delay : void 0,
          ...
          return (
              m.forEach((G, k) => {
                  ...
                  Ci({ config: Y, event: h, eventTarget: r, elementRoot: I, elementApi: we }).forEach((D, X) => {
      ...
      function gs(e) {
          ...
          let { store: r, computedStyle: n } = e,
              o = (0, hV.default)(e, SV),
              { element: i, actionItem: a, immediate: s, pluginInstance: c, continuous: f, restingValue: E, eventId: p } = o,
              h = !f,
              g = RV(),
          ...
          if ((r.dispatch((0, Oe.instanceAdded)((0, EV.default)({ instanceId: g, elementId: A, origin: q, refType: m, skipMotion: N, skipToValue: C }, o))), Ky(document.body, "ix2-animation-started", g), s)) {
              lW(r, g);
              return;
          }
          jt({ store: r, select: ({ ixInstances: G }) => G[g], onChange: zy }), h && r.dispatch((0, Oe.instanceStarted)(g, b.tick));
      }
      function _s(e, t) {
      ...
      function zy(e, t) {
          ...
          if (Ni(G, N.mediaQueryKey) && (n || r || o)) {
              ...
              if (o) {
                  if (b) {
                      let k = hs({ store: t, eventId: p, eventTarget: h, eventStateKey: g, actionListId: S, groupIndex: E + 1, verbose: A });
                      A && !k && t.dispatch((0, Oe.actionListPlaybackChanged)({ actionListId: S, isPlaying: !1 }));
                  }
                  _s(e, t);
              }
          }
  ...
  var rI = u((gK, tI) => {
      ...
      Tr.define(
          ...
          (tI.exports = function (e, t) {
              ...
              function g() {
                  (o = i && Tr.env("design")), (h = Tr.env("slug") || a.pathname || ""), Tr.scroll.off(b), (p = []);
      ...
      Mi.define(
          ...
          (nI.exports = function (e) {
              ...
              function N(M) {
                  ...
                  if (!(Mi.env("design") || (window.$.mobile && /(?:^|\s)ui-link(?:$|\s)/.test(I.className)))) {
                      var x = P(I) ? I.hash : "";
                      if (x !== "") {
                          var D = e(x);
                          D.length &&
              ...
              function q(M, I) {
                  ...
                  if (x !== D) {
                      var X = k(M, x, D),
                          ...
                          te = function () {
                              var L = Date.now() - $;
                              window.scroll(0, Y(x, D, L, X)), L <= X ? s(te) : typeof I == "function" && I();
                          };
                      s(te);
                  }
              }
      ...
      _W.define(
          ...
          (oI.exports = function (e) {
              ...
              function n(i) {
                  ...
                  function p(P) {
                      var A = P.touches;
                      (A && A.length > 1) || ((a = !0), A ? ((s = !0), (f = A[0].clientX)) : (f = P.clientX), (E = f));
                  }
                  function h(P) {
                      if (a) {
                          ...
                          var A = P.touches,
                              ...
                              m = w - E;
                          (E = w), Math.abs(m) > c && r && String(r()) === "" && (o("swipe", P, { direction: m > 0 ? "right" : "left" }), S());
                      }
                  }
                  function g(P) {
      ...
      Di.define(
          ...
          (uI.exports = function (e, t) {
              ...
              function m(L, H) {
                  ...
                  if (((U.handler = null), (U.redirect = j.attr("data-redirect")), P.test(ue))) {
                      U.handler = I;
                      return;
                  }
                  if (!ue) {
              ...
              function N() {
                  ...
                  n.on("change", s + ' form input[type="checkbox"]:not(' + L + ")", (ce) => {
                      ...
                      n.on("change", s + ' form input[type="radio"]', (ce) => {
                          e(`input[name="${ce.target.name}"]:not(${L})`).map((he, vt) => e(vt).siblings(H).removeClass(j));
                          let J = e(ce.target);
                          J.hasClass("w-radio-input") || J.siblings(H).addClass(j);
                      }),
                      ue.forEach(([ce, J]) => {
                          n.on("focus", s + ` form input[type="${ce}"]:not(` + J + ")", (he) => {
                              e(he.target).siblings(J).addClass(U), e(he.target).filter(Q).siblings(J).addClass(F);
                          }),
                              n.on("blur", s + ` form input[type="${ce}"]:not(` + J + ")", (he) => {
              ...
              function ee(L, H, j, U) {
                  ...
                  return (
                      H === "password"
                          ...
                          : L.attr("required")
                          ? U
                              ? f.test(L.attr("type")) && (E.test(U) || (F = "Please enter a valid email address for: " + j))
                              : (F = "Please fill out the required field: " + j)
                          : j === "g-recaptcha-response" && !U && (F = "Please confirm you\u2019re not a robot."),
                      F
                  );
              }
              function M(L) {
              ...
              function I(L) {
                  ...
                  t.each(j, function (J, he) {
                      f.test(he) && (j.EMAIL = J), /^((full[ _-]?)?name)$/i.test(he) && (F = J), /^(first[ _-]?name)$/i.test(he) && (j.FNAME = J), /^(last[ _-]?name)$/i.test(he) && (j.LNAME = J);
                  }),
              ...
              function X(L, H) {
                  ...
                  if (
                      ...
                      V.on("click keydown", function (_) {
                          ...
                          J.removeAttr("data-value"), J.val(""), K.html(""), F.toggle(!0), ue.toggle(!1), he.focus();
                      }),
                          J.on("change", function (_) {
                              (j = _.target && _.target.files && _.target.files[0]), j && (F.toggle(!1), ce.toggle(!1), Q.toggle(!0), Q.focus(), K.text(j.name), T() || q(H), (H.fileUploads[L].uploading = !0), $(j, v));
                          });
                  ...
                  function l(_) {
                      var O = _.responseJSON && _.responseJSON.msg,
                          z = Pt;
                      typeof O == "string" && O.indexOf("InvalidFileTypeError") === 0 ? (z = _e) : typeof O == "string" && O.indexOf("MaxFileSizeError") === 0 && (z = B),
                          de.text(z),
  ...
  var fI = u((TK, lI) => {
      ...
      qt.define(
          ...
          (lI.exports = function (e, t) {
              ...
              function C() {
                  (f = p && qt.env("design")), (E = qt.env("editor")), (s = e(document.body)), (c = i.find(g)), c.length && (c.each(Y), q(), G());
              }
              function q() {
                  qt.resize.off(k);
              }
              ...
              function Y(d, V) {
                  ...
                  _e && _e.attr("href") === "/" && _e.attr("aria-label") == null && _e.attr("aria-label", "home"),
                      ...
                      B.menu.off(g),
                      I(B),
                      f ? (ee(B), B.el.on("setting" + g, x(B))) : (M(B), B.button.on("click" + g, L(B)), B.menu.on("click" + g, "a", H(B)), B.button.on("keydown" + g, D(B)), B.el.on("keydown" + g, X(B))),
                      F(d, V);
              }
              function ie(d, V) {
                  var K = e.data(V, g);
              ...
              function D(d) {
                  return function (V) {
                      switch (V.keyCode) {
                          ...
                          case xe.HOME:
                          case xe.END:
                              return d.open ? (V.keyCode === xe.END ? (d.selectedIdx = d.links.length - 1) : (d.selectedIdx = 0), $(d), V.preventDefault(), V.stopPropagation()) : (V.preventDefault(), V.stopPropagation());
                      }
                  };
              }
              function X(d) {
                  return function (V) {
                      if (d.open)
                          switch (((d.selectedIdx = d.links.index(document.activeElement)), V.keyCode)) {
                              case xe.HOME:
                              case xe.END:
                                  return V.keyCode === xe.END ? (d.selectedIdx = d.links.length - 1) : (d.selectedIdx = 0), $(d), V.preventDefault(), V.stopPropagation();
                              case xe.ESCAPE:
              ...
              function he(d, V) {
                  if (d.open) return;
                  (d.open = !0), d.menu.each(ce), d.links.addClass(w), d.dropdowns.addClass(b), d.dropdownToggle.addClass(P), d.dropdownList.addClass(A), d.button.addClass(S);
                  var K = d.config,
                      B = K.animation;
                  ...
                  var _e = vt(d),
                      ...
                      l = d.el.height(),
                      v = d.el[0];
                  if ((F(0, v), m.intro(0, v), qt.redraw.up(), f || i.on("click" + g, d.outside), V)) {
                      _();
                      return;
                  }
...
Webflow.require("ix2").init({
  events: {
      e: {
          ...
          mediaQueries: ["main"],
          target: { selector: ".link-block.animation-01", originalId: "63bc0ce6938b48180f7ca095|8ed1b952-23ff-bc0f-8964-7935e1d755b9", appliesTo: "CLASS" },
          targets: [{ selector: ".link-block.animation-01", originalId: "63bc0ce6938b48180f7ca095|8ed1b952-23ff-bc0f-8964-7935e1d755b9", appliesTo: "CLASS" }],
      ...
      "e-3": {
          ...
          mediaQueries: ["main"],
          target: { selector: ".link-block.animation-02", originalId: "63bc0ce6938b48180f7ca095|eb8dec28-6d4f-c86f-c68f-8ba9fc65946e", appliesTo: "CLASS" },
          targets: [{ selector: ".link-block.animation-02", originalId: "63bc0ce6938b48180f7ca095|eb8dec28-6d4f-c86f-c68f-8ba9fc65946e", appliesTo: "CLASS" }],
          config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
      ...
      "e-5": {
          ...
          mediaQueries: ["main"],
          target: { selector: ".link-block.animation-03", originalId: "63bc0ce6938b48180f7ca095|babb1a74-1ca8-4e3b-31b3-e12d0db617be", appliesTo: "CLASS" },
          targets: [{ selector: ".link-block.animation-03", originalId: "63bc0ce6938b48180f7ca095|babb1a74-1ca8-4e3b-31b3-e12d0db617be", appliesTo: "CLASS" }],
          config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
      ...
      "e-6": {
          ...
          animationType: "preset",
          eventTypeId: "MOUSE_OUT",
          action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-6", affectedElements: {}, playInReverse: false, autoStopEventId: "e-59" } },
          mediaQueries: ["main"],
          target: { selector: ".link-block.animation-03", originalId: "63bc0ce6938b48180f7ca095|babb1a74-1ca8-4e3b-31b3-e12d0db617be", appliesTo: "CLASS" },
          targets: [{ selector: ".link-block.animation-03", originalId: "63bc0ce6938b48180f7ca095|babb1a74-1ca8-4e3b-31b3-e12d0db617be", appliesTo: "CLASS" }],
          config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
      ...
      "e-7": {
          ...
          mediaQueries: ["main"],
          target: { selector: ".link-block.animation-04", originalId: "63bc0ce6938b48180f7ca095|bdac6aad-ea46-de38-5682-bb015f0792db", appliesTo: "CLASS" },
          targets: [{ selector: ".link-block.animation-04", originalId: "63bc0ce6938b48180f7ca095|bdac6aad-ea46-de38-5682-bb015f0792db", appliesTo: "CLASS" }],
          config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
      ...
      "e-9": {
          ...
          mediaQueries: ["main"],
          target: { selector: ".link-block.animation-05", originalId: "63bc0ce6938b48180f7ca095|eb817875-6024-a502-e779-eda35e78cc94", appliesTo: "CLASS" },
          targets: [{ selector: ".link-block.animation-05", originalId: "63bc0ce6938b48180f7ca095|eb817875-6024-a502-e779-eda35e78cc94", appliesTo: "CLASS" }],
          config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
      ...
      "e-11": {
          ...
          action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-11", affectedElements: {}, playInReverse: false, autoStopEventId: "e-12" } },
          mediaQueries: ["main", "medium", "small", "tiny"],
          target: { selector: ".fade-in-on-scroll", originalId: "63bc0ce6938b48180f7ca095|48a7b1d3-b07a-497b-d5ee-44049694be04", appliesTo: "CLASS" },
          targets: [{ selector: ".fade-in-on-scroll", originalId: "63bc0ce6938b48180f7ca095|48a7b1d3-b07a-497b-d5ee-44049694be04", appliesTo: "CLASS" }],
      ...
      "e-13": {
          ...
          animationType: "custom",
          eventTypeId: "SCROLL_INTO_VIEW",
          action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-12", affectedElements: {}, playInReverse: false, autoStopEventId: "e-14" } },
          mediaQueries: ["main", "medium", "small", "tiny"],
          target: { selector: ".fade-in-move-on-scroll", originalId: "63bc0ce6938b48180f7ca095|d153327e-0b89-53f6-8af6-bfb408d9df35", appliesTo: "CLASS" },
          targets: [{ selector: ".fade-in-move-on-scroll", originalId: "63bc0ce6938b48180f7ca095|d153327e-0b89-53f6-8af6-bfb408d9df35", appliesTo: "CLASS" }],
          config: { loop: false, playInReverse: false, scrollOffsetValue: 0, scrollOffsetUnit: "%", delay: null, direction: null, effectIn: null },
      ...
      "e-15": {
          ...
          mediaQueries: ["main", "medium", "small", "tiny"],
          target: { selector: ".fade-in-slace-on-scroll", originalId: "63bc0ce6938b48180f7ca095|b40307ba-5bc6-bd78-6e19-712b5713de87", appliesTo: "CLASS" },
          targets: [{ selector: ".fade-in-slace-on-scroll", originalId: "63bc0ce6938b48180f7ca095|b40307ba-5bc6-bd78-6e19-712b5713de87", appliesTo: "CLASS" }],
          config: { loop: false, playInReverse: false, scrollOffsetValue: 0, scrollOffsetUnit: "%", delay: null, direction: null, effectIn: null },
      ...
      "e-17": {
          ...
          mediaQueries: ["main", "medium", "small", "tiny"],
          target: { selector: ".fade-in-blur-on-scroll", originalId: "63bc0ce6938b48180f7ca095|548a5b34-b2c2-5a0b-7e8c-aacb07ebb25f", appliesTo: "CLASS" },
          targets: [{ selector: ".fade-in-blur-on-scroll", originalId: "63bc0ce6938b48180f7ca095|548a5b34-b2c2-5a0b-7e8c-aacb07ebb25f", appliesTo: "CLASS" }],
          config: { loop: false, playInReverse: false, scrollOffsetValue: 0, scrollOffsetUnit: "%", delay: null, direction: null, effectIn: null },
      ...
      "e-19": {
          ...
          target: { id: "63bc0ce6938b48c6107ca08b", appliesTo: "PAGE", styleBlockIds: [] },
          targets: [{ id: "63bc0ce6938b48c6107ca08b", appliesTo: "PAGE", styleBlockIds: [] }],
          config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
          createdOn: 1639044628728,
      },
      "e-20": {
          id: "e-20",
          name: "",
          ...
          action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-48", affectedElements: {}, playInReverse: false, autoStopEventId: "e-19" } },
          mediaQueries: ["main", "medium", "small"],
          target: { id: "63bc0ce6938b48c6107ca08b", appliesTo: "PAGE", styleBlockIds: [] },
          targets: [{ id: "63bc0ce6938b48c6107ca08b", appliesTo: "PAGE", styleBlockIds: [] }],
      ...
      "e-23": {
          ...
          animationType: "custom",
          eventTypeId: "MOUSE_OVER",
          action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-17", affectedElements: {}, playInReverse: false, autoStopEventId: "e-24" } },
          mediaQueries: ["main", "medium", "small", "tiny"],
          target: { selector: ".template-container", originalId: "63bc0ce6938b484ee97ca091|c32ddce7-9ecb-b557-b599-6de1d8239110", appliesTo: "CLASS" },
          targets: [{ selector: ".template-container", originalId: "63bc0ce6938b484ee97ca091|c32ddce7-9ecb-b557-b599-6de1d8239110", appliesTo: "CLASS" }],
          config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
      ...
      "e-24": {
          ...
          animationType: "custom",
          eventTypeId: "MOUSE_OUT",
          action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-18", affectedElements: {}, playInReverse: false, autoStopEventId: "e-23" } },
          mediaQueries: ["main", "medium", "small", "tiny"],
          target: { selector: ".template-container", originalId: "63bc0ce6938b484ee97ca091|c32ddce7-9ecb-b557-b599-6de1d8239110", appliesTo: "CLASS" },
          targets: [{ selector: ".template-container", originalId: "63bc0ce6938b484ee97ca091|c32ddce7-9ecb-b557-b599-6de1d8239110", appliesTo: "CLASS" }],
          config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
      ...
      "e-31": {
          ...
          animationType: "custom",
          eventTypeId: "PAGE_START",
          action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-16", affectedElements: {}, playInReverse: false, autoStopEventId: "e-32" } },
          mediaQueries: ["main", "medium", "small", "tiny"],
          target: { id: "63bc0ce6938b48ff997ca092", appliesTo: "PAGE", styleBlockIds: [] },
          targets: [{ id: "63bc0ce6938b48ff997ca092", appliesTo: "PAGE", styleBlockIds: [] }],
          config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
      ...
      "e-33": {
          ...
          animationType: "custom",
          eventTypeId: "PAGE_START",
          action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-16", affectedElements: {}, playInReverse: false, autoStopEventId: "e-34" } },
          mediaQueries: ["main", "medium", "small", "tiny"],
          target: { id: "63bc0ce6938b4823937ca093", appliesTo: "PAGE", styleBlockIds: [] },
          targets: [{ id: "63bc0ce6938b4823937ca093", appliesTo: "PAGE", styleBlockIds: [] }],
          config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
      ...
      "e-35": {
          ...
          animationType: "custom",
          eventTypeId: "PAGE_START",
          action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-16", affectedElements: {}, playInReverse: false, autoStopEventId: "e-36" } },
          mediaQueries: ["main", "medium", "small", "tiny"],
          target: { id: "63bc0ce6938b485b3b7ca08e", appliesTo: "PAGE", styleBlockIds: [] },
          targets: [{ id: "63bc0ce6938b485b3b7ca08e", appliesTo: "PAGE", styleBlockIds: [] }],
          config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
      ...
      "e-37": {
          ...
          mediaQueries: ["main"],
          target: { selector: ".link-block-2.animation-03", originalId: "62e39d1f126f5823c2e4b5ce|8ed1b952-23ff-bc0f-8964-7935e1d755b9", appliesTo: "CLASS" },
          targets: [{ selector: ".link-block-2.animation-03", originalId: "62e39d1f126f5823c2e4b5ce|8ed1b952-23ff-bc0f-8964-7935e1d755b9", appliesTo: "CLASS" }],
          config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
          createdOn: 1638368629176,
      },
      "e-38": {
          ...
          animationType: "custom",
          eventTypeId: "MOUSE_OUT",
          action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-20", affectedElements: {}, playInReverse: false, autoStopEventId: "e-47" } },
          mediaQueries: ["main", "medium", "small", "tiny"],
          target: { selector: ".contact-field-text", originalId: "62e39d1f126f588edfe4b5c8|183927b3-82e6-bdab-7199-4e547274e639", appliesTo: "CLASS" },
          targets: [{ selector: ".contact-field-text", originalId: "62e39d1f126f588edfe4b5c8|183927b3-82e6-bdab-7199-4e547274e639", appliesTo: "CLASS" }],
          config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
          createdOn: 1659528051152,
      },
      "e-39": {
          id: "e-39",
          name: "",
          ...
          mediaQueries: ["main"],
          target: { selector: ".link-block-2.animation-05", originalId: "6319f69c5ef0f30066db6dff|eb817875-6024-a502-e779-eda35e78cc94", appliesTo: "CLASS" },
          targets: [{ selector: ".link-block-2.animation-05", originalId: "6319f69c5ef0f30066db6dff|eb817875-6024-a502-e779-eda35e78cc94", appliesTo: "CLASS" }],
          config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
          createdOn: 1638369634769,
      },
      "e-40": {
          ...
          mediaQueries: ["main", "medium", "small", "tiny"],
          target: { selector: ".subscribe-field-text", originalId: "62ea2f329d12251b48ea50cb|6fbf96fd-708a-56bf-c7d3-029c12d50c11", appliesTo: "CLASS" },
          targets: [{ selector: ".subscribe-field-text", originalId: "62ea2f329d12251b48ea50cb|6fbf96fd-708a-56bf-c7d3-029c12d50c11", appliesTo: "CLASS" }],
          config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
          createdOn: 1659534008993,
      },
      "e-41": {
          id: "e-41",
          name: "",
          ...
          mediaQueries: ["main"],
          target: { selector: ".link-block-2.animation-03", originalId: "6319f69c5ef0f30066db6dff|babb1a74-1ca8-4e3b-31b3-e12d0db617be", appliesTo: "CLASS" },
          targets: [{ selector: ".link-block-2.animation-03", originalId: "6319f69c5ef0f30066db6dff|babb1a74-1ca8-4e3b-31b3-e12d0db617be", appliesTo: "CLASS" }],
          config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
          createdOn: 1638368990971,
      },
      "e-42": {
          ...
          animationType: "custom",
          eventTypeId: "MOUSE_OVER",
          action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-25", affectedElements: {}, playInReverse: false, autoStopEventId: "e-44" } },
          mediaQueries: ["main", "medium", "small", "tiny"],
          target: { id: "63bc0ce6938b48180f7ca095|8c331566-379f-cbef-9da9-4f92e2bbebed", appliesTo: "ELEMENT", styleBlockIds: [] },
          targets: [{ id: "63bc0ce6938b48180f7ca095|8c331566-379f-cbef-9da9-4f92e2bbebed", appliesTo: "ELEMENT", styleBlockIds: [] }],
          config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
          createdOn: 1663835376148,
      },
      "e-43": {
          id: "e-43",
          name: "",
          animationType: "custom",
          eventTypeId: "MOUSE_OVER",
          action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-22", affectedElements: {}, playInReverse: false, autoStopEventId: "e-40" } },
          mediaQueries: ["main", "medium", "small", "tiny"],
          target: { selector: ".subscribe-field-text", originalId: "62ea2f329d12251b48ea50cb|6fbf96fd-708a-56bf-c7d3-029c12d50c11", appliesTo: "CLASS" },
          targets: [{ selector: ".subscribe-field-text", originalId: "62ea2f329d12251b48ea50cb|6fbf96fd-708a-56bf-c7d3-029c12d50c11", appliesTo: "CLASS" }],
          config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
          createdOn: 1659534008991,
      },
      "e-44": {
          id: "e-44",
          name: "",
          animationType: "custom",
          eventTypeId: "MOUSE_OUT",
          action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-21", affectedElements: {}, playInReverse: false, autoStopEventId: "e-42" } },
          mediaQueries: ["main", "medium", "small", "tiny"],
          target: { id: "63bc0ce6938b48180f7ca095|8c331566-379f-cbef-9da9-4f92e2bbebed", appliesTo: "ELEMENT", styleBlockIds: [] },
          targets: [{ id: "63bc0ce6938b48180f7ca095|8c331566-379f-cbef-9da9-4f92e2bbebed", appliesTo: "ELEMENT", styleBlockIds: [] }],
          config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
          createdOn: 1663835376149,
      },
      "e-45": {
          id: "e-45",
          name: "",
      ...
      "e-46": {
          ...
          animationType: "custom",
          eventTypeId: "MOUSE_OVER",
          action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a", affectedElements: {}, playInReverse: false, autoStopEventId: "e-37" } },
          mediaQueries: ["main"],
          target: { selector: ".link-block-2.animation-03", originalId: "62e39d1f126f5823c2e4b5ce|8ed1b952-23ff-bc0f-8964-7935e1d755b9", appliesTo: "CLASS" },
          targets: [{ selector: ".link-block-2.animation-03", originalId: "62e39d1f126f5823c2e4b5ce|8ed1b952-23ff-bc0f-8964-7935e1d755b9", appliesTo: "CLASS" }],
          config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
      ...
      "e-47": {
          ...
          animationType: "custom",
          eventTypeId: "MOUSE_OVER",
          action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-22", affectedElements: {}, playInReverse: false, autoStopEventId: "e-51" } },
          mediaQueries: ["main", "medium", "small", "tiny"],
          target: { selector: ".contact-field-text", originalId: "62e39d1f126f588edfe4b5c8|183927b3-82e6-bdab-7199-4e547274e639", appliesTo: "CLASS" },
          targets: [{ selector: ".contact-field-text", originalId: "62e39d1f126f588edfe4b5c8|183927b3-82e6-bdab-7199-4e547274e639", appliesTo: "CLASS" }],
          config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
          createdOn: 1659528051150,
      },
      "e-48": {
          id: "e-48",
          name: "",
          animationType: "custom",
          eventTypeId: "MOUSE_OUT",
          action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-10", affectedElements: {}, playInReverse: false, autoStopEventId: "e-52" } },
          mediaQueries: ["main"],
          target: { selector: ".link-block-2.animation-05", originalId: "6319f69c5ef0f30066db6dff|eb817875-6024-a502-e779-eda35e78cc94", appliesTo: "CLASS" },
          targets: [{ selector: ".link-block-2.animation-05", originalId: "6319f69c5ef0f30066db6dff|eb817875-6024-a502-e779-eda35e78cc94", appliesTo: "CLASS" }],
          config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
      ...
      "e-51": {
          ...
          animationType: "custom",
          eventTypeId: "SCROLL_INTO_VIEW",
          action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-12", affectedElements: {}, playInReverse: false, autoStopEventId: "e-52" } },
          mediaQueries: ["main", "medium", "small", "tiny"],
          target: { selector: ".logo-small-container", originalId: "63bc0ce6938b48c6107ca08b|f078fdf9-afcd-dd23-e056-d7d58c77dcd8", appliesTo: "CLASS" },
          targets: [{ selector: ".logo-small-container", originalId: "63bc0ce6938b48c6107ca08b|f078fdf9-afcd-dd23-e056-d7d58c77dcd8", appliesTo: "CLASS" }],
          config: { loop: false, playInReverse: false, scrollOffsetValue: 0, scrollOffsetUnit: "%", delay: null, direction: null, effectIn: null },
      ...
      "e-55": {
          ...
          animationType: "custom",
          eventTypeId: "SCROLL_INTO_VIEW",
          action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-28", affectedElements: {}, playInReverse: false, autoStopEventId: "e-56" } },
          mediaQueries: ["main", "medium", "small", "tiny"],
          target: { selector: ".trusted-item-header", originalId: "63bc0ce6938b48c6107ca08b|0f99c55c-aef0-ebd9-f690-9830ff12bd24", appliesTo: "CLASS" },
          targets: [{ selector: ".trusted-item-header", originalId: "63bc0ce6938b48c6107ca08b|0f99c55c-aef0-ebd9-f690-9830ff12bd24", appliesTo: "CLASS" }],
          config: { loop: false, playInReverse: false, scrollOffsetValue: 0, scrollOffsetUnit: "%", delay: null, direction: null, effectIn: null },
          createdOn: 1615749404457,
      },
      "e-65": {
          id: "e-65",
          name: "",
          animationType: "custom",
          eventTypeId: "SCROLL_INTO_VIEW",
          action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-28", affectedElements: {}, playInReverse: false, autoStopEventId: "e-62" } },
          mediaQueries: ["main", "medium", "small", "tiny"],
          target: { selector: ".footer-list-item", originalId: "a91eae88-2cd2-a6a2-03b1-a73f4b02afec", appliesTo: "CLASS" },
          targets: [{ selector: ".footer-list-item", originalId: "a91eae88-2cd2-a6a2-03b1-a73f4b02afec", appliesTo: "CLASS" }],
          config: { loop: false, playInReverse: false, scrollOffsetValue: 0, scrollOffsetUnit: "%", delay: null, direction: null, effectIn: null },
          createdOn: 1615749650340,
      },
      "e-69": {
          id: "e-69",
          name: "",
          animationType: "custom",
          eventTypeId: "SCROLL_INTO_VIEW",
          action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-28", affectedElements: {}, playInReverse: false, autoStopEventId: "e-61" } },
          mediaQueries: ["main", "medium", "small", "tiny"],
          target: { selector: ".social-media-icon", originalId: "a91eae88-2cd2-a6a2-03b1-a73f4b02afd2", appliesTo: "CLASS" },
          targets: [{ selector: ".social-media-icon", originalId: "a91eae88-2cd2-a6a2-03b1-a73f4b02afd2", appliesTo: "CLASS" }],
          config: { loop: false, playInReverse: false, scrollOffsetValue: 0, scrollOffsetUnit: "%", delay: null, direction: null, effectIn: null },
          createdOn: 1615751775634,
      },
      "e-73": {
          id: "e-73",
          name: "",
          ...
          mediaQueries: ["main"],
          target: { selector: ".experience-card", originalId: "63bc0ce6938b48c6107ca08b|c9a3eb7f-e26e-bb52-e19d-39f848eddb94", appliesTo: "CLASS" },
          targets: [{ selector: ".experience-card", originalId: "63bc0ce6938b48c6107ca08b|98338922-2ac0-90bd-27f5-a4d54b51da2f", appliesTo: "CLASS" }],
          config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
          createdOn: 1672847045650,
      },
      "e-74": {
          id: "e-74",
          name: "",
          animationType: "custom",
          eventTypeId: "MOUSE_OUT",
          action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-34", affectedElements: {}, playInReverse: false, autoStopEventId: "e-73" } },
          mediaQueries: ["main"],
          target: { selector: ".experience-card", originalId: "63bc0ce6938b48c6107ca08b|c9a3eb7f-e26e-bb52-e19d-39f848eddb94", appliesTo: "CLASS" },
          targets: [{ selector: ".experience-card", originalId: "63bc0ce6938b48c6107ca08b|98338922-2ac0-90bd-27f5-a4d54b51da2f", appliesTo: "CLASS" }],
          config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
          createdOn: 1672847045651,
      },
      "e-83": {
          id: "e-83",
          name: "",
          animationType: "custom",
          eventTypeId: "MOUSE_OVER",
          action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-35", affectedElements: {}, playInReverse: false, autoStopEventId: "e-84" } },
          mediaQueries: ["main", "medium", "small", "tiny"],
          target: { selector: ".logo-holder", originalId: "28288ee9-aae6-3bba-5f56-45a89ddc7adf", appliesTo: "CLASS" },
          targets: [{ selector: ".logo-holder", originalId: "28288ee9-aae6-3bba-5f56-45a89ddc7adf", appliesTo: "CLASS" }],
          config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
          createdOn: 1672847702417,
      },
      "e-84": {
          id: "e-84",
          name: "",
          animationType: "custom",
          eventTypeId: "MOUSE_OUT",
          action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-36", affectedElements: {}, playInReverse: false, autoStopEventId: "e-83" } },
          mediaQueries: ["main", "medium", "small", "tiny"],
          target: { selector: ".logo-holder", originalId: "28288ee9-aae6-3bba-5f56-45a89ddc7adf", appliesTo: "CLASS" },
          targets: [{ selector: ".logo-holder", originalId: "28288ee9-aae6-3bba-5f56-45a89ddc7adf", appliesTo: "CLASS" }],
          config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
          createdOn: 1672847702418,
      },
      "e-104": {
          id: "e-104",
          name: "",
          animationType: "custom",
          eventTypeId: "SCROLL_INTO_VIEW",
          action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-12", affectedElements: {}, playInReverse: false, autoStopEventId: "e-105" } },
          mediaQueries: ["main", "medium", "small", "tiny"],
          target: { selector: ".download-badge-container", originalId: "63bc0ce6938b48c6107ca08b|8ba9ae63-375e-564e-c431-ba2fd2d554ea", appliesTo: "CLASS" },
          targets: [{ selector: ".download-badge-container", originalId: "63bc0ce6938b48c6107ca08b|8ba9ae63-375e-564e-c431-ba2fd2d554ea", appliesTo: "CLASS" }],
          config: { loop: false, playInReverse: false, scrollOffsetValue: 0, scrollOffsetUnit: "%", delay: null, direction: null, effectIn: null },
          createdOn: 1672914782593,
      },
      "e-110": {
          id: "e-110",
          name: "",
          animationType: "custom",
          eventTypeId: "PAGE_FINISH",
          action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-49", affectedElements: {}, playInReverse: false, autoStopEventId: "e-109" } },
          mediaQueries: ["main", "medium", "small", "tiny"],
          target: { id: "63bc0ce6938b48c6107ca08b", appliesTo: "PAGE", styleBlockIds: [] },
          targets: [{ id: "63bc0ce6938b48c6107ca08b", appliesTo: "PAGE", styleBlockIds: [] }],
          config: { loop: true, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
          createdOn: 1673428894127,
      },
      "e-111": {
          id: "e-111",
          name: "",
          ...
          action: { id: "", actionTypeId: "GENERAL_CONTINUOUS_ACTION", config: { actionListId: "a-50", affectedElements: {}, duration: 0 } },
          mediaQueries: ["main", "medium", "small", "tiny"],
          target: { selector: ".infnite-image", originalId: "c34b435b-0809-a8ce-f4e3-d841430be5b7", appliesTo: "CLASS" },
          targets: [{ selector: ".infnite-image", originalId: "c34b435b-0809-a8ce-f4e3-d841430be5b7", appliesTo: "CLASS" }],
          config: [
              { continuousParameterGroupId: "a-50-p", selectedAxis: "X_AXIS", basedOn: "ELEMENT", reverse: false, smoothing: 96, restingState: 50 },
              { continuousParameterGroupId: "a-50-p-2", selectedAxis: "Y_AXIS", basedOn: "ELEMENT", reverse: false, smoothing: 96, restingState: 50 },
          ],
          createdOn: 1673428992934,
      },
      "e-112": {
          id: "e-112",
          name: "",
          animationType: "custom",
          eventTypeId: "MOUSE_OVER",
          action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-51", affectedElements: {}, playInReverse: false, autoStopEventId: "e-113" } },
          mediaQueries: ["main", "medium", "small", "tiny"],
          target: { selector: ".infnite-image", originalId: "c34b435b-0809-a8ce-f4e3-d841430be5b7", appliesTo: "CLASS" },
          targets: [{ selector: ".infnite-image", originalId: "c34b435b-0809-a8ce-f4e3-d841430be5b7", appliesTo: "CLASS" }],
          config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
          createdOn: 1673429117187,
      },
      "e-113": {
          id: "e-113",
          name: "",
          animationType: "custom",
          eventTypeId: "MOUSE_OUT",
          action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-52", affectedElements: {}, playInReverse: false, autoStopEventId: "e-112" } },
          mediaQueries: ["main", "medium", "small", "tiny"],
          target: { selector: ".infnite-image", originalId: "c34b435b-0809-a8ce-f4e3-d841430be5b7", appliesTo: "CLASS" },
          targets: [{ selector: ".infnite-image", originalId: "c34b435b-0809-a8ce-f4e3-d841430be5b7", appliesTo: "CLASS" }],
          config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
          createdOn: 1673429117189,
      },
      "e-114": {
          id: "e-114",
          name: "",
          ...
          action: { id: "", actionTypeId: "GENERAL_CONTINUOUS_ACTION", config: { actionListId: "a-53", affectedElements: {}, duration: 0 } },
          mediaQueries: ["main", "medium", "small"],
          target: { selector: ".grey-cards-wrapper", originalId: "63bc0ce6938b48c6107ca08b|eaf7432c-fa80-bdc6-2db3-6199aa2326cb", appliesTo: "CLASS" },
          targets: [{ selector: ".grey-cards-wrapper", originalId: "63bc0ce6938b48c6107ca08b|eaf7432c-fa80-bdc6-2db3-6199aa2326cb", appliesTo: "CLASS" }],
          config: [{ continuousParameterGroupId: "a-53-p", smoothing: 94, startsEntering: true, addStartOffset: false, addOffsetValue: 50, startsExiting: false, addEndOffset: false, endOffsetValue: 50 }],
          createdOn: 1673431855644,
      },
      "e-115": {
          id: "e-115",
          name: "",
          animationType: "preset",
          eventTypeId: "SCROLL_INTO_VIEW",
          action: { id: "", actionTypeId: "SLIDE_EFFECT", instant: false, config: { actionListId: "slideInLeft", autoStopEventId: "e-116" } },
          mediaQueries: ["main", "medium", "small", "tiny"],
          target: { id: "63bc0ce6938b48c6107ca08b|fb6e61c5-348f-515a-51ba-509ea31acd9b", appliesTo: "ELEMENT", styleBlockIds: [] },
          targets: [{ id: "63bc0ce6938b48c6107ca08b|fb6e61c5-348f-515a-51ba-509ea31acd9b", appliesTo: "ELEMENT", styleBlockIds: [] }],
          config: { loop: false, playInReverse: false, scrollOffsetValue: 10, scrollOffsetUnit: "%", delay: 100, direction: "LEFT", effectIn: true },
          createdOn: 1673432072650,
      },
      "e-117": {
          id: "e-117",
          name: "",
          animationType: "preset",
          eventTypeId: "SCROLL_INTO_VIEW",
          action: { id: "", actionTypeId: "SLIDE_EFFECT", instant: false, config: { actionListId: "slideInRight", autoStopEventId: "e-118" } },
          mediaQueries: ["main", "medium", "small", "tiny"],
          target: { id: "63bc0ce6938b48c6107ca08b|472e4dc8-aac6-32c2-d384-9ed9dd06f470", appliesTo: "ELEMENT", styleBlockIds: [] },
          targets: [{ id: "63bc0ce6938b48c6107ca08b|472e4dc8-aac6-32c2-d384-9ed9dd06f470", appliesTo: "ELEMENT", styleBlockIds: [] }],
          config: { loop: false, playInReverse: false, scrollOffsetValue: 10, scrollOffsetUnit: "%", delay: 200, direction: "RIGHT", effectIn: true },
          createdOn: 1673432160537,
      },
      "e-119": {
          id: "e-119",
          name: "",
          ...
          action: { id: "", actionTypeId: "POP_EFFECT", instant: false, config: { actionListId: "pop", autoStopEventId: "e-120" } },
          mediaQueries: ["main", "medium", "small", "tiny"],
          target: { selector: ".small-cards", originalId: "63bc0ce6938b48c6107ca08b|472e4dc8-aac6-32c2-d384-9ed9dd06f470", appliesTo: "CLASS" },
          targets: [{ selector: ".small-cards", originalId: "63bc0ce6938b48c6107ca08b|472e4dc8-aac6-32c2-d384-9ed9dd06f470", appliesTo: "CLASS" }],
          config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: 0, direction: null, effectIn: null },
          createdOn: 1673432170406,
      },
      "e-120": {
          id: "e-120",
          name: "",
          ...
          action: { id: "", actionTypeId: "POP_EFFECT", instant: false, config: { actionListId: "pop", autoStopEventId: "e-119" } },
          mediaQueries: ["main", "medium", "small", "tiny"],
          target: { selector: ".small-cards", originalId: "63bc0ce6938b48c6107ca08b|472e4dc8-aac6-32c2-d384-9ed9dd06f470", appliesTo: "CLASS" },
          targets: [{ selector: ".small-cards", originalId: "63bc0ce6938b48c6107ca08b|472e4dc8-aac6-32c2-d384-9ed9dd06f470", appliesTo: "CLASS" }],
          config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: 0, direction: null, effectIn: null },
          createdOn: 1673432170407,
      },
      "e-121": {
          id: "e-121",
          name: "",
          ...
          mediaQueries: ["main", "medium", "small", "tiny"],
          target: { selector: ".generate-section", originalId: "63bc0ce6938b48c6107ca08b|c16de67f-14ec-9bc2-a767-e408e335d282", appliesTo: "CLASS" },
          targets: [{ selector: ".generate-section", originalId: "63bc0ce6938b48c6107ca08b|c16de67f-14ec-9bc2-a767-e408e335d282", appliesTo: "CLASS" }],
          config: { loop: false, playInReverse: false, scrollOffsetValue: 0, scrollOffsetUnit: "%", delay: null, direction: null, effectIn: null },
          createdOn: 1673432428559,
      },
      "e-123": {
          id: "e-123",
          name: "",
          ...
          action: { id: "", actionTypeId: "GENERAL_CONTINUOUS_ACTION", config: { actionListId: "a-50", affectedElements: {}, duration: 0 } },
          mediaQueries: ["main", "medium", "small", "tiny"],
          target: { selector: ".about-us-image", originalId: "63bc0ce6938b48c6107ca08b|187acc39-44be-b28d-93f4-09c852e80023", appliesTo: "CLASS" },
          targets: [{ selector: ".about-us-image", originalId: "63bc0ce6938b48c6107ca08b|187acc39-44be-b28d-93f4-09c852e80023", appliesTo: "CLASS" }],
          config: [
              { continuousParameterGroupId: "a-50-p", selectedAxis: "X_AXIS", basedOn: "ELEMENT", reverse: false, smoothing: 95, restingState: 50 },
              { continuousParameterGroupId: "a-50-p-2", selectedAxis: "Y_AXIS", basedOn: "ELEMENT", reverse: false, smoothing: 95, restingState: 50 },
          ],
          createdOn: 1673432683786,
      },
      "e-124": {
          id: "e-124",
          name: "",
      ...
      "e-125": {
          ...
          animationType: "custom",
          eventTypeId: "PAGE_FINISH",
          action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-56", affectedElements: {}, playInReverse: false, autoStopEventId: "e-124" } },
          mediaQueries: ["tiny"],
          target: { id: "63bc0ce6938b48c6107ca08b", appliesTo: "PAGE", styleBlockIds: [] },
          targets: [{ id: "63bc0ce6938b48c6107ca08b", appliesTo: "PAGE", styleBlockIds: [] }],
          config: { loop: true, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
          createdOn: 1673446606121,
      },
      "e-129": {
          id: "e-129",
          name: "",
          ...
          mediaQueries: ["main", "medium", "small", "tiny"],
          target: { id: "63bc0ce6938b48c6107ca08b|604edd17-092b-35df-a4bf-168a7d79ece0", appliesTo: "ELEMENT", styleBlockIds: [] },
          targets: [{ id: "63bc0ce6938b48c6107ca08b|604edd17-092b-35df-a4bf-168a7d79ece0", appliesTo: "ELEMENT", styleBlockIds: [] }],
          config: [{ continuousParameterGroupId: "a-60-p", smoothing: 92, startsEntering: true, addStartOffset: true, addOffsetValue: 0, startsExiting: true, addEndOffset: true, endOffsetValue: 50 }],
          createdOn: 1673860474247,
      },
      "e-130": {
          id: "e-130",
          name: "",
          animationType: "custom",
          eventTypeId: "SCROLL_INTO_VIEW",
          action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-12", affectedElements: {}, playInReverse: false, autoStopEventId: "e-131" } },
          mediaQueries: ["main", "medium", "small", "tiny"],
          target: { selector: ".about-us-grid", originalId: "63bc0ce6938b48c6107ca08b|e782cfbc-2326-d748-45eb-266f94def588", appliesTo: "CLASS" },
          targets: [{ selector: ".about-us-grid", originalId: "63bc0ce6938b48c6107ca08b|e782cfbc-2326-d748-45eb-266f94def588", appliesTo: "CLASS" }],
          config: { loop: false, playInReverse: false, scrollOffsetValue: 0, scrollOffsetUnit: "%", delay: null, direction: null, effectIn: null },
          createdOn: 1673861029677,
      },
      "e-132": {
          id: "e-132",
          name: "",
          animationType: "custom",
          eventTypeId: "SCROLLING_IN_VIEW",
          action: { id: "", actionTypeId: "GENERAL_CONTINUOUS_ACTION", config: { actionListId: "a-61", affectedElements: {}, duration: 0 } },
          mediaQueries: ["tiny"],
          target: { selector: ".grey-cards-wrapper", originalId: "63bc0ce6938b48c6107ca08b|eaf7432c-fa80-bdc6-2db3-6199aa2326cb", appliesTo: "CLASS" },
          targets: [{ selector: ".grey-cards-wrapper", originalId: "63bc0ce6938b48c6107ca08b|eaf7432c-fa80-bdc6-2db3-6199aa2326cb", appliesTo: "CLASS" }],
          config: [{ continuousParameterGroupId: "a-61-p", smoothing: 92, startsEntering: true, addStartOffset: false, addOffsetValue: 50, startsExiting: false, addEndOffset: false, endOffsetValue: 50 }],
          createdOn: 1673861126419,
      },
      "e-134": {
          id: "e-134",
          name: "",
      ...
      "e-135": {
          ...
          animationType: "custom",
          eventTypeId: "SCROLL_INTO_VIEW",
          action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-63", affectedElements: {}, playInReverse: false, autoStopEventId: "e-136" } },
          mediaQueries: ["main", "medium", "small", "tiny"],
          target: { id: "63bc0ce6938b48c6107ca08b|929d74e2-0f92-03e3-438f-132bac7e1644", appliesTo: "ELEMENT", styleBlockIds: [] },
          targets: [{ id: "63bc0ce6938b48c6107ca08b|929d74e2-0f92-03e3-438f-132bac7e1644", appliesTo: "ELEMENT", styleBlockIds: [] }],
          config: { loop: false, playInReverse: false, scrollOffsetValue: 0, scrollOffsetUnit: "%", delay: null, direction: null, effectIn: null },
          createdOn: 1674661421377,
      },
      "e-137": {
          id: "e-137",
          name: "",
          animationType: "custom",
          eventTypeId: "SCROLL_INTO_VIEW",
          action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-12", affectedElements: {}, playInReverse: false, autoStopEventId: "e-138" } },
          mediaQueries: ["main", "medium", "small", "tiny"],
          target: { id: "01e017fe-fbca-72ae-a56e-41d557142d70", appliesTo: "ELEMENT", styleBlockIds: [] },
          targets: [{ id: "01e017fe-fbca-72ae-a56e-41d557142d70", appliesTo: "ELEMENT", styleBlockIds: [] }],
          config: { loop: false, playInReverse: false, scrollOffsetValue: 0, scrollOffsetUnit: "%", delay: null, direction: null, effectIn: null },
          createdOn: 1676061271030,
      },
      "e-139": {
          id: "e-139",
          name: "",
          ...
          target: { id: "63bc0ce6938b48c6107ca08b", appliesTo: "PAGE", styleBlockIds: [] },
          targets: [{ id: "63bc0ce6938b48c6107ca08b", appliesTo: "PAGE", styleBlockIds: [] }],
          config: [{ continuousParameterGroupId: "a-64-p", smoothing: 50, startsEntering: true, addStartOffset: false, addOffsetValue: 50, startsExiting: false, addEndOffset: false, endOffsetValue: 50 }],
          createdOn: 1676391865951,
      },
      "e-140": {
          id: "e-140",
          name: "",
          animationType: "custom",
          eventTypeId: "SCROLL_INTO_VIEW",
          action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-12", affectedElements: {}, playInReverse: false, autoStopEventId: "e-141" } },
          mediaQueries: ["main", "medium", "small", "tiny"],
          target: { selector: ".client-logo-holder", originalId: "63bc0ce6938b48c6107ca08b|1cc50305-d0c5-05a9-aa92-4c1391979e8f", appliesTo: "CLASS" },
          targets: [{ selector: ".client-logo-holder", originalId: "63bc0ce6938b48c6107ca08b|1cc50305-d0c5-05a9-aa92-4c1391979e8f", appliesTo: "CLASS" }],
          config: { loop: false, playInReverse: false, scrollOffsetValue: 0, scrollOffsetUnit: "%", delay: null, direction: null, effectIn: null },
          createdOn: 1676397004065,
      },
      "e-142": {
          id: "e-142",
          name: "",
      ...
      "e-145": {
          ...
          action: { id: "", actionTypeId: "GENERAL_CONTINUOUS_ACTION", config: { actionListId: "a-64", affectedElements: {}, duration: 0 } },
          mediaQueries: ["main", "medium", "small", "tiny"],
          target: { id: "63bc0ce6938b4839817ca08c", appliesTo: "PAGE", styleBlockIds: [] },
          targets: [{ id: "63bc0ce6938b4839817ca08c", appliesTo: "PAGE", styleBlockIds: [] }],
          config: [{ continuousParameterGroupId: "a-64-p", smoothing: 50, startsEntering: true, addStartOffset: false, addOffsetValue: 50, startsExiting: false, addEndOffset: false, endOffsetValue: 50 }],
          createdOn: 1676397582916,
      },
      "e-146": {
          id: "e-146",
          name: "",
          ...
          action: { id: "", actionTypeId: "GENERAL_CONTINUOUS_ACTION", config: { actionListId: "a-64", affectedElements: {}, duration: 0 } },
          mediaQueries: ["main", "medium", "small", "tiny"],
          target: { id: "63bc0ce6938b48f4937ca08d", appliesTo: "PAGE", styleBlockIds: [] },
          targets: [{ id: "63bc0ce6938b48f4937ca08d", appliesTo: "PAGE", styleBlockIds: [] }],
          config: [{ continuousParameterGroupId: "a-64-p", smoothing: 50, startsEntering: true, addStartOffset: false, addOffsetValue: 50, startsExiting: false, addEndOffset: false, endOffsetValue: 50 }],
          createdOn: 1676397592035,
      },
      "e-147": {
          id: "e-147",
          name: "",
          ...
          targets: [{ id: "63bc0ce6938b48c6107ca08b", appliesTo: "PAGE", styleBlockIds: [] }],
          config: [
              { continuousParameterGroupId: "a-65-p", selectedAxis: "X_AXIS", basedOn: "VIEWPORT", reverse: false, smoothing: 90, restingState: 50 },
              { continuousParameterGroupId: "a-65-p-2", selectedAxis: "Y_AXIS", basedOn: "VIEWPORT", reverse: false, smoothing: 90, restingState: 50 },
          ],
          createdOn: 1676397688835,
      },
      "e-148": {
          id: "e-148",
          name: "",
          animationType: "custom",
          eventTypeId: "SCROLL_INTO_VIEW",
          action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-11", affectedElements: {}, playInReverse: false, autoStopEventId: "e-149" } },
          mediaQueries: ["main", "medium", "small", "tiny"],
          target: { selector: ".infinite-ai-images-holder", originalId: "c34b435b-0809-a8ce-f4e3-d841430be5ad", appliesTo: "CLASS" },
          targets: [{ selector: ".infinite-ai-images-holder", originalId: "c34b435b-0809-a8ce-f4e3-d841430be5ad", appliesTo: "CLASS" }],
          config: { loop: false, playInReverse: false, scrollOffsetValue: 0, scrollOffsetUnit: "%", delay: null, direction: null, effectIn: null },
          createdOn: 1676398318954,
      },
      "e-150": {
          id: "e-150",
          name: "",
          animationType: "custom",
          eventTypeId: "SCROLLING_IN_VIEW",
          action: { id: "", actionTypeId: "GENERAL_CONTINUOUS_ACTION", config: { actionListId: "a-66", affectedElements: {}, duration: 0 } },
          mediaQueries: ["main", "medium", "small", "tiny"],
          target: { id: "a3d87bef-2bd5-e85b-5339-6f5065bd21da", appliesTo: "ELEMENT", styleBlockIds: [] },
          targets: [{ id: "a3d87bef-2bd5-e85b-5339-6f5065bd21da", appliesTo: "ELEMENT", styleBlockIds: [] }],
          config: [{ continuousParameterGroupId: "a-66-p", smoothing: 90, startsEntering: true, addStartOffset: false, addOffsetValue: 50, startsExiting: false, addEndOffset: false, endOffsetValue: 50 }],
          createdOn: 1677347285733,
      },
      "e-151": {
          id: "e-151",
          name: "",
          animationType: "custom",
          eventTypeId: "MOUSE_OVER",
          action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-67", affectedElements: {}, playInReverse: false, autoStopEventId: "e-152" } },
          mediaQueries: ["main", "medium", "small", "tiny"],
          target: { selector: ".circle-image-parent", originalId: "a3d87bef-2bd5-e85b-5339-6f5065bd21f0", appliesTo: "CLASS" },
          targets: [{ selector: ".circle-image-parent", originalId: "a3d87bef-2bd5-e85b-5339-6f5065bd21f0", appliesTo: "CLASS" }],
          config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
          createdOn: 1677349563677,
      },
      "e-152": {
          id: "e-152",
          name: "",
          animationType: "custom",
          eventTypeId: "MOUSE_OUT",
          action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-68", affectedElements: {}, playInReverse: false, autoStopEventId: "e-151" } },
          mediaQueries: ["main", "medium", "small", "tiny"],
          target: { selector: ".circle-image-parent", originalId: "a3d87bef-2bd5-e85b-5339-6f5065bd21f0", appliesTo: "CLASS" },
          targets: [{ selector: ".circle-image-parent", originalId: "a3d87bef-2bd5-e85b-5339-6f5065bd21f0", appliesTo: "CLASS" }],
          config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
          createdOn: 1677349563678,
      },
  },
  actionLists: {
      a: {
          id: "a",
          title: "ðŸ‘† Link Block Animation 01 -> Hover In",
          actionItemGroups: [
              {
                  actionItems: [
                      {
                          ...
                          config: {
                              ...
                              easing: "",
                              duration: 500,
                              target: { useEventTarget: "CHILDREN", selector: ".link-block-underline", selectorGuids: ["e7362ff3-1cb5-d07c-af2e-df27fc2f3066"] },
                              xValue: -101,
                              xUnit: "%",
                              yUnit: "PX",
                              zUnit: "PX",
      ...
      "a-2": {
          id: "a-2",
          title: "ðŸ‘† Link Block Animation 01 -> Hover Out",
          actionItemGroups: [
              {
                  actionItems: [
                      {
      ...
      "a-3": {
          id: "a-3",
          title: "ðŸ‘† Link Block Animation 02 -> Hover In",
          actionItemGroups: [
              {
                  actionItems: [
                      { id: "a-3-n", actionTypeId: "TRANSFORM_MOVE", config: { delay: 0, easing: "ease", duration: 800, target: {}, xValue: -101, xUnit: "%", yUnit: "PX", zUnit: "PX" } },
                      { id: "a-3-n-2", actionTypeId: "TRANSFORM_MOVE", config: { delay: 0, easing: "ease", duration: 800, target: {}, xValue: 101, xUnit: "%", yUnit: "PX", zUnit: "PX" } },
                  ],
              },
              {
                  actionItems: [
                      { id: "a-3-n-3", actionTypeId: "TRANSFORM_MOVE", config: { delay: 0, easing: "ease", duration: 400, target: {}, xValue: 0, xUnit: "%", yUnit: "PX", zUnit: "PX" } },
                      { id: "a-3-n-4", actionTypeId: "TRANSFORM_MOVE", config: { delay: 0, easing: "ease", duration: 400, target: {}, xValue: 0, xUnit: "%", yUnit: "PX", zUnit: "PX" } },
                  ],
              },
          ],
          useFirstGroupAsInitialState: true,
      ...
      "a-4": {
          id: "a-4",
          title: "ðŸ‘† Link Block Animation 02 -> Hover Out",
          actionItemGroups: [
              {
                  actionItems: [
                      { id: "a-4-n-2", actionTypeId: "TRANSFORM_MOVE", config: { delay: 0, easing: "ease", duration: 400, target: {}, xValue: -101, xUnit: "%", yUnit: "PX", zUnit: "PX" } },
                      { id: "a-4-n", actionTypeId: "TRANSFORM_MOVE", config: { delay: 0, easing: "ease", duration: 400, target: {}, xValue: 101, xUnit: "%", yUnit: "PX", zUnit: "PX" } },
                  ],
              },
              {
                  actionItems: [
                      { id: "a-4-n-3", actionTypeId: "TRANSFORM_MOVE", config: { delay: 0, easing: "ease", duration: 0, target: {}, xValue: 101, xUnit: "%", yUnit: "PX", zUnit: "PX" } },
                      { id: "a-4-n-4", actionTypeId: "TRANSFORM_MOVE", config: { delay: 0, easing: "ease", duration: 0, target: {}, xValue: -101, xUnit: "%", yUnit: "PX", zUnit: "PX" } },
                  ],
              },
          ],
          useFirstGroupAsInitialState: false,
      ...
      "a-5": {
          id: "a-5",
          title: "ðŸ‘† Link Block Animation 03 -> Hover In",
          actionItemGroups: [
              {
                  actionItems: [
                      { id: "a-5-n", actionTypeId: "TRANSFORM_MOVE", config: { delay: 0, easing: "ease", duration: 400, target: {}, xValue: -101, xUnit: "%", yUnit: "PX", zUnit: "PX" } },
                      { id: "a-5-n-2", actionTypeId: "TRANSFORM_MOVE", config: { delay: 0, easing: "ease", duration: 400, target: {}, xValue: -150, xUnit: "%", yUnit: "PX", zUnit: "PX" } },
                  ],
              },
              {
                  actionItems: [
                      { id: "a-5-n-3", actionTypeId: "TRANSFORM_MOVE", config: { delay: 0, easing: "ease", duration: 600, target: {}, xValue: 0, xUnit: "%", yUnit: "PX", zUnit: "PX" } },
                      { id: "a-5-n-4", actionTypeId: "TRANSFORM_MOVE", config: { delay: 0, easing: "ease", duration: 600, target: {}, xValue: 0, xUnit: "%", yUnit: "PX", zUnit: "PX" } },
                  ],
              },
          ],
          useFirstGroupAsInitialState: true,
      ...
      "a-6": {
          id: "a-6",
          title: "ðŸ‘† Link Block Animation 03 -> Hover Out",
          actionItemGroups: [
              {
                  actionItems: [
                      { id: "a-6-n", actionTypeId: "TRANSFORM_MOVE", config: { delay: 0, easing: "ease", duration: 400, target: {}, xValue: 101, xUnit: "%", yUnit: "PX", zUnit: "PX" } },
                      { id: "a-6-n-2", actionTypeId: "TRANSFORM_MOVE", config: { delay: 0, easing: "ease", duration: 400, target: {}, xValue: 150, xUnit: "%", yUnit: "PX", zUnit: "PX" } },
                  ],
              },
              {
                  actionItems: [
                      { id: "a-6-n-3", actionTypeId: "TRANSFORM_MOVE", config: { delay: 0, easing: "ease", duration: 0, target: {}, xValue: -101, xUnit: "%", yUnit: "PX", zUnit: "PX" } },
                      { id: "a-6-n-4", actionTypeId: "TRANSFORM_MOVE", config: { delay: 0, easing: "ease", duration: 0, target: {}, xValue: -150, xUnit: "%", yUnit: "PX", zUnit: "PX" } },
                  ],
              },
          ],
          useFirstGroupAsInitialState: false,
      ...
      "a-7": {
          id: "a-7",
          title: "ðŸ‘† Link Block Animation 04 -> Hover In",
          actionItemGroups: [
              {
                  actionItems: [
                      { id: "a-7-n", actionTypeId: "TRANSFORM_MOVE", config: { delay: 0, easing: "ease", duration: 400, target: {}, xValue: -101, xUnit: "%", yUnit: "PX", zUnit: "PX" } },
                      { id: "a-7-n-2", actionTypeId: "TRANSFORM_MOVE", config: { delay: 0, easing: "ease", duration: 400, target: {}, xValue: 101, xUnit: "%", yUnit: "PX", zUnit: "PX" } },
                  ],
              },
              {
                  actionItems: [
                      { id: "a-7-n-3", actionTypeId: "TRANSFORM_MOVE", config: { delay: 0, easing: "ease", duration: 700, target: {}, xValue: 0, xUnit: "%", yUnit: "PX", zUnit: "PX" } },
                      { id: "a-7-n-4", actionTypeId: "TRANSFORM_MOVE", config: { delay: 0, easing: "ease", duration: 700, target: {}, xValue: 0, xUnit: "%", yUnit: "PX", zUnit: "PX" } },
                  ],
              },
          ],
          useFirstGroupAsInitialState: true,
      ...
      "a-8": {
          id: "a-8",
          title: "ðŸ‘† Link Block Animation 04 -> Hover Out",
          actionItemGroups: [
              {
                  actionItems: [
                      { id: "a-8-n", actionTypeId: "TRANSFORM_MOVE", config: { delay: 0, easing: "ease", duration: 600, target: {}, xValue: -101, xUnit: "%", yUnit: "PX", zUnit: "PX" } },
                      { id: "a-8-n-2", actionTypeId: "TRANSFORM_MOVE", config: { delay: 0, easing: "ease", duration: 600, target: {}, xValue: 101, xUnit: "%", yUnit: "PX", zUnit: "PX" } },
                  ],
              },
          ],
          useFirstGroupAsInitialState: false,
      ...
      "a-9": {
          id: "a-9",
          title: "ðŸ‘† Link Block Animation 05 -> Hover In",
          actionItemGroups: [
              {
                  actionItems: [
                      {
                      ...
                      },
                      {
                          ...
                          config: { delay: 0, easing: "ease", duration: 600, target: { useEventTarget: "CHILDREN", selector: ".link-block-underline", selectorGuids: ["e7362ff3-1cb5-d07c-af2e-df27fc2f3066"] }, value: 0, unit: "" },
                      },
                  ],
              },
              {
                  actionItems: [
                      ...
                      },
                      {
                          id: "a-9-n-6",
                          actionTypeId: "STYLE_OPACITY",
                          config: { delay: 0, easing: "ease", duration: 400, target: { useEventTarget: "CHILDREN", selector: ".link-block-underline", selectorGuids: ["e7362ff3-1cb5-d07c-af2e-df27fc2f3066"] }, value: 1, unit: "" },
                      },
                      {
                          id: "a-9-n-5",
                          actionTypeId: "STYLE_SIZE",
      ...
      "a-10": {
          id: "a-10",
          title: "ðŸ‘† Link Block Animation 05 -> Hover Out",
          actionItemGroups: [
              {
                  actionItems: [
                      {
                  ...
                  actionItems: [
                      {
                          id: "a-11-n",
                          actionTypeId: "STYLE_OPACITY",
                          config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: true, id: "63bc0ce6938b48180f7ca095|48a7b1d3-b07a-497b-d5ee-44049694be04" }, value: 0, unit: "" },
                      },
                  ],
              },
              {
                  actionItems: [
                      {
                          id: "a-11-n-2",
                          actionTypeId: "STYLE_OPACITY",
                          config: { delay: 100, easing: "ease", duration: 1000, target: { useEventTarget: true, id: "63bc0ce6938b48180f7ca095|48a7b1d3-b07a-497b-d5ee-44049694be04" }, value: 1, unit: "" },
                      },
                  ],
              },
          ],
          ...
          actionItemGroups: [
              {
                  actionItems: [
                      ...
                      },
                      {
                          id: "a-12-n-3",
                          actionTypeId: "TRANSFORM_MOVE",
                          config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: true, id: "63bc0ce6938b48180f7ca095|48a7b1d3-b07a-497b-d5ee-44049694be04" }, yValue: 25, xUnit: "PX", yUnit: "px", zUnit: "PX" },
                      },
                  ],
              },
              {
                  actionItems: [
                      ...
                      },
                      {
                          id: "a-12-n-4",
                          actionTypeId: "TRANSFORM_MOVE",
                          config: { delay: 100, easing: "ease", duration: 1000, target: { useEventTarget: true, id: "63bc0ce6938b48180f7ca095|48a7b1d3-b07a-497b-d5ee-44049694be04" }, yValue: 0, xUnit: "PX", yUnit: "px", zUnit: "PX" },
                      },
                  ],
              },
          ],
          ...
          actionItemGroups: [
              {
                  actionItems: [
                      ...
                      },
                      {
                          ...
                          config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: true, id: "63bc0ce6938b48180f7ca095|48a7b1d3-b07a-497b-d5ee-44049694be04" }, xValue: 1.1, yValue: 1.1, locked: true },
                      },
                  ],
              },
              {
                  actionItems: [
                      ...
                      },
                      {
                          id: "a-13-n-5",
                          actionTypeId: "TRANSFORM_SCALE",
                          config: { delay: 100, easing: "ease", duration: 1000, target: { useEventTarget: true, id: "63bc0ce6938b48180f7ca095|48a7b1d3-b07a-497b-d5ee-44049694be04" }, xValue: 1, yValue: 1, locked: true },
                      },
                  ],
              },
          ],
                  ...
                  actionItems: [
                      ...
                      },
                      {
                          ...
                          config: {
                              ...
                              easing: "",
                              duration: 500,
                              target: { useEventTarget: true, id: "63bc0ce6938b48180f7ca095|48a7b1d3-b07a-497b-d5ee-44049694be04" },
                              filters: [{ type: "blur", filterId: "3278", value: 5, unit: "px" }],
                          },
                      },
                  ],
              },
                  ...
                  actionItems: [
                      ...
                      },
                      {
                          ...
                          config: {
                              ...
                              duration: 1000,
                              target: { useEventTarget: true, id: "63bc0ce6938b48180f7ca095|48a7b1d3-b07a-497b-d5ee-44049694be04" },
                              filters: [{ type: "blur", filterId: "3278", value: 0, unit: "px" }],
                          },
                      },
                  ],
              },
      ...
      "a-15": {
          id: "a-15",
          title: "â± Page On Load Animation",
          actionItemGroups: [
              {
                  actionItems: [
                      {
                          id: "a-15-n-16",
                          actionTypeId: "STYLE_OPACITY",
                          config: { delay: 0, easing: "", duration: 500, target: { selector: ".nav-menu-container", selectorGuids: ["ce88a8fd-a045-613d-2bfb-d48d93b0d60d"] }, value: 0, unit: "" },
                      },
                      {
                          id: "a-15-n-31",
                          actionTypeId: "STYLE_OPACITY",
                          config: { delay: 0, easing: "", duration: 500, target: { selector: ".button.big", selectorGuids: ["fd674514-2dde-6b7f-5cec-addf8406cbda", "08a52344-0fed-9843-8889-bea83118c6df"] }, value: 0, unit: "" },
                      },
                      {
                          id: "a-15-n-30",
                          actionTypeId: "STYLE_SIZE",
                          config: {
                              ...
                              easing: "",
                              duration: 500,
                              target: { selector: ".button.big", selectorGuids: ["fd674514-2dde-6b7f-5cec-addf8406cbda", "08a52344-0fed-9843-8889-bea83118c6df"] },
                              widthValue: 0,
                              widthUnit: "px",
                              heightUnit: "PX",
                              locked: false,
                      ...
                      },
                      {
                          id: "a-15-n-20",
                          actionTypeId: "STYLE_OPACITY",
                          config: { delay: 0, easing: "", duration: 500, target: { selector: ".hero-section-title", selectorGuids: ["84551193-936f-a065-d124-b16257e1d3b0"] }, value: 0, unit: "" },
                      },
                      {
                          id: "a-15-n-19",
                          actionTypeId: "TRANSFORM_SCALE",
                          config: { delay: 0, easing: "", duration: 500, target: { selector: ".hero-section-title", selectorGuids: ["84551193-936f-a065-d124-b16257e1d3b0"] }, xValue: 0.9, yValue: 0.9, locked: true },
                      },
                      {
                          id: "a-15-n-18",
                          actionTypeId: "TRANSFORM_MOVE",
                          config: { delay: 0, easing: "", duration: 500, target: { selector: ".hero-section-title", selectorGuids: ["84551193-936f-a065-d124-b16257e1d3b0"] }, yValue: 30, xUnit: "PX", yUnit: "px", zUnit: "PX" },
                      },
                      {
                          id: "a-15-n-21",
                          actionTypeId: "STYLE_OPACITY",
                          config: { delay: 0, easing: "", duration: 500, target: { selector: ".hero-section-paragraph-holder", selectorGuids: ["e2d4f45d-d042-590e-4181-86d6bcadc263"] }, value: 0, unit: "" },
                      },
                      {
                          id: "a-15-n-23",
                          actionTypeId: "TRANSFORM_MOVE",
                          config: { delay: 0, easing: "", duration: 500, target: { selector: ".hero-section-paragraph-holder", selectorGuids: ["e2d4f45d-d042-590e-4181-86d6bcadc263"] }, yValue: 30, xUnit: "PX", yUnit: "px", zUnit: "PX" },
                      },
                      {
                          id: "a-15-n-22",
                          actionTypeId: "TRANSFORM_SCALE",
                          config: { delay: 0, easing: "", duration: 500, target: { selector: ".hero-section-paragraph-holder", selectorGuids: ["e2d4f45d-d042-590e-4181-86d6bcadc263"] }, xValue: 0.9, yValue: 0.9, locked: true },
                      },
                      {
                          id: "a-15-n-35",
                          actionTypeId: "TRANSFORM_MOVE",
                          config: { delay: 0, easing: "", duration: 500, target: { selector: ".hero-section-button-holder", selectorGuids: ["dd00f3e4-8fe6-0ab5-a28f-17664b091f0a"] }, yValue: 20, xUnit: "PX", yUnit: "px", zUnit: "PX" },
                      },
                      {
                          id: "a-15-n-34",
                          actionTypeId: "STYLE_OPACITY",
                          config: { delay: 0, easing: "", duration: 500, target: { selector: ".hero-section-button-holder", selectorGuids: ["dd00f3e4-8fe6-0ab5-a28f-17664b091f0a"] }, value: 0, unit: "" },
                      },
                  ],
              },
              {
                  actionItems: [
                      {
                          id: "a-15-n-24",
                          actionTypeId: "STYLE_OPACITY",
                          config: { delay: 0, easing: "ease", duration: 700, target: { selector: ".hero-section-title", selectorGuids: ["84551193-936f-a065-d124-b16257e1d3b0"] }, value: 1, unit: "" },
                      },
                      {
                          id: "a-15-n-26",
                          actionTypeId: "TRANSFORM_MOVE",
                          config: { delay: 0, easing: "ease", duration: 700, target: { selector: ".hero-section-title", selectorGuids: ["84551193-936f-a065-d124-b16257e1d3b0"] }, yValue: 0, xUnit: "PX", yUnit: "px", zUnit: "PX" },
                      },
                      {
                          id: "a-15-n-25",
                          actionTypeId: "TRANSFORM_SCALE",
                          config: { delay: 0, easing: "ease", duration: 700, target: { selector: ".hero-section-title", selectorGuids: ["84551193-936f-a065-d124-b16257e1d3b0"] }, xValue: 1, yValue: 1, locked: true },
                      },
                      {
                          id: "a-15-n-27",
                          actionTypeId: "STYLE_OPACITY",
                          config: { delay: 300, easing: "ease", duration: 700, target: { selector: ".hero-section-paragraph-holder", selectorGuids: ["e2d4f45d-d042-590e-4181-86d6bcadc263"] }, value: 1, unit: "" },
                      },
                      {
                          id: "a-15-n-29",
                          actionTypeId: "TRANSFORM_SCALE",
                          config: { delay: 300, easing: "ease", duration: 700, target: { selector: ".hero-section-paragraph-holder", selectorGuids: ["e2d4f45d-d042-590e-4181-86d6bcadc263"] }, xValue: 1, yValue: 1, locked: true },
                      },
                      {
                          id: "a-15-n-28",
                          actionTypeId: "TRANSFORM_MOVE",
                          config: {
                              ...
                              easing: "ease",
                              duration: 700,
                              target: { selector: ".hero-section-paragraph-holder", selectorGuids: ["e2d4f45d-d042-590e-4181-86d6bcadc263"] },
                              yValue: 0,
                              xUnit: "PX",
                              yUnit: "px",
                              zUnit: "PX",
                      ...
                      },
                      {
                          id: "a-15-n-33",
                          actionTypeId: "STYLE_OPACITY",
                          config: { delay: 500, easing: "ease", duration: 800, target: { selector: ".button.big", selectorGuids: ["fd674514-2dde-6b7f-5cec-addf8406cbda", "08a52344-0fed-9843-8889-bea83118c6df"] }, value: 1, unit: "" },
                      },
                      {
                          id: "a-15-n-17",
                          actionTypeId: "STYLE_OPACITY",
                          config: { delay: 500, easing: "ease", duration: 1000, target: { selector: ".nav-menu-container", selectorGuids: ["ce88a8fd-a045-613d-2bfb-d48d93b0d60d"] }, value: 1, unit: "" },
                      },
                      {
                          id: "a-15-n-36",
                          actionTypeId: "TRANSFORM_MOVE",
                          config: {
                              ...
                              easing: "ease",
                              duration: 700,
                              target: { selector: ".hero-section-button-holder", selectorGuids: ["dd00f3e4-8fe6-0ab5-a28f-17664b091f0a"] },
                              yValue: 0,
                              xUnit: "PX",
                              yUnit: "px",
                              zUnit: "PX",
                      ...
                      },
                      {
                          id: "a-15-n-37",
                          actionTypeId: "STYLE_OPACITY",
                          config: { delay: 500, easing: "ease", duration: 700, target: { selector: ".hero-section-button-holder", selectorGuids: ["dd00f3e4-8fe6-0ab5-a28f-17664b091f0a"] }, value: 1, unit: "" },
                      },
                  ],
              },
          ],
          useFirstGroupAsInitialState: true,
          createdOn: 1639044633546,
      },
      "a-48": {
          id: "a-48",
          title: "Infinite Auto Switch",
          actionItemGroups: [
              {
                  actionItems: [
                      {
                          id: "a-48-n",
                          actionTypeId: "TRANSFORM_MOVE",
                          config: { delay: 0, easing: "", duration: 500, target: { selector: ".text-auto-switch", selectorGuids: ["d322b1e3-1547-91b2-3442-1557bd0efe3b"] }, yValue: 0, xUnit: "PX", yUnit: "px", zUnit: "PX" },
                      },
                  ],
              },
              {
                  actionItems: [
                      {
                          id: "a-48-n-2",
                          actionTypeId: "TRANSFORM_MOVE",
                          config: { delay: 1000, easing: "ease", duration: 800, target: { selector: ".text-auto-switch", selectorGuids: ["d322b1e3-1547-91b2-3442-1557bd0efe3b"] }, yValue: -25, xUnit: "PX", yUnit: "px", zUnit: "PX" },
                      },
                  ],
              },
              {
                  actionItems: [
                      {
                          id: "a-48-n-3",
                          actionTypeId: "TRANSFORM_MOVE",
                          config: { delay: 2000, easing: "ease", duration: 800, target: { selector: ".text-auto-switch", selectorGuids: ["d322b1e3-1547-91b2-3442-1557bd0efe3b"] }, yValue: -50, xUnit: "PX", yUnit: "px", zUnit: "PX" },
                      },
                  ],
              },
              {
                  actionItems: [
                      {
                          id: "a-48-n-4",
                          actionTypeId: "TRANSFORM_MOVE",
                          config: { delay: 2000, easing: "ease", duration: 800, target: { selector: ".text-auto-switch", selectorGuids: ["d322b1e3-1547-91b2-3442-1557bd0efe3b"] }, yValue: -74, xUnit: "PX", yUnit: "px", zUnit: "PX" },
                      },
                  ],
              },
              {
                  actionItems: [
                      {
                          id: "a-48-n-5",
                          actionTypeId: "TRANSFORM_MOVE",
                          config: { delay: 2000, easing: "ease", duration: 800, target: { selector: ".text-auto-switch", selectorGuids: ["d322b1e3-1547-91b2-3442-1557bd0efe3b"] }, yValue: -98, xUnit: "PX", yUnit: "px", zUnit: "PX" },
                      },
                  ],
              },
          ],
          useFirstGroupAsInitialState: true,
          createdOn: 1673357314960,
      },
      "a-17": {
          id: "a-17",
          title: "ðŸ‘†Template Card -> Hover On",
          actionItemGroups: [
              {
                  actionItems: [
                      { id: "a-17-n", actionTypeId: "STYLE_OPACITY", config: { delay: 0, easing: "", duration: 500, target: {}, value: 0, unit: "" } },
                      { id: "a-17-n-5", actionTypeId: "TRANSFORM_SCALE", config: { delay: 0, easing: "", duration: 500, target: {}, xValue: 1, yValue: 1, locked: true } },
                      {
                          id: "a-17-n-2",
                          actionTypeId: "TRANSFORM_MOVE",
                          config: {
                              ...
                              easing: "",
                              duration: 500,
                              target: { useEventTarget: "CHILDREN", selector: ".link-block.animation-01", selectorGuids: ["333430c2-6b08-7b1b-e65f-6baa136f520e", "cd35f39f-9f47-f14e-26ff-57a6fdc1b473"] },
                              yValue: 20,
                              xUnit: "PX",
                              yUnit: "%",
                              zUnit: "PX",
              ...
              {
                  actionItems: [
                      { id: "a-17-n-3", actionTypeId: "STYLE_OPACITY", config: { delay: 0, easing: "ease", duration: 800, target: {}, value: 1, unit: "" } },
                      {
                          id: "a-17-n-4",
                          actionTypeId: "TRANSFORM_MOVE",
                          config: {
                      ...
                      { id: "a-17-n-6", actionTypeId: "TRANSFORM_SCALE", config: { delay: 0, easing: "ease", duration: 800, target: {}, xValue: 1.05, yValue: 1.05, locked: true } },
                  ],
              },
          ],
          useFirstGroupAsInitialState: true,
      ...
      "a-18": {
          id: "a-18",
          title: "ðŸ‘†Template Card -> Hover Out",
          actionItemGroups: [
              {
                  actionItems: [
                      { id: "a-18-n", actionTypeId: "STYLE_OPACITY", config: { delay: 0, easing: "ease", duration: 800, target: {}, value: 0, unit: "" } },
                      { id: "a-18-n-2", actionTypeId: "TRANSFORM_SCALE", config: { delay: 0, easing: "ease", duration: 800, target: {}, xValue: 1, yValue: 1, locked: true } },
                      {
                          id: "a-18-n-3",
                          actionTypeId: "TRANSFORM_MOVE",
                          config: {
      ...
      "a-16": {
          id: "a-16",
          title: "â° Default On Load Animation",
          actionItemGroups: [
              {
                  actionItems: [
                      {
                          id: "a-16-n",
                          actionTypeId: "TRANSFORM_MOVE",
                          config: { delay: 0, easing: "", duration: 500, target: { selector: ".navbar", selectorGuids: ["e120672f-745f-faa1-71e7-c904666db13c"] }, yValue: -100, xUnit: "PX", yUnit: "%", zUnit: "PX" },
                      },
                      { id: "a-16-n-2", actionTypeId: "STYLE_OPACITY", config: { delay: 0, easing: "", duration: 500, target: { selector: ".navbar", selectorGuids: ["e120672f-745f-faa1-71e7-c904666db13c"] }, value: 0, unit: "" } },
                      { id: "a-16-n-3", actionTypeId: "TRANSFORM_MOVE", config: { delay: 0, easing: "", duration: 500, target: {}, yValue: 30, xUnit: "PX", yUnit: "%", zUnit: "PX" } },
                      { id: "a-16-n-4", actionTypeId: "TRANSFORM_SCALE", config: { delay: 0, easing: "", duration: 500, target: {}, xValue: 0.8, yValue: 0.8, locked: true } },
                      { id: "a-16-n-5", actionTypeId: "STYLE_OPACITY", config: { delay: 0, easing: "", duration: 500, target: {}, value: 0, unit: "" } },
                      { id: "a-16-n-6", actionTypeId: "TRANSFORM_MOVE", config: { delay: 0, easing: "", duration: 500, target: {}, yValue: 30, xUnit: "PX", yUnit: "%", zUnit: "PX" } },
                      { id: "a-16-n-8", actionTypeId: "STYLE_OPACITY", config: { delay: 0, easing: "", duration: 500, target: {}, value: 0, unit: "" } },
                      { id: "a-16-n-7", actionTypeId: "TRANSFORM_SCALE", config: { delay: 0, easing: "", duration: 500, target: {}, xValue: 0.8, yValue: 0.8, locked: true } },
                      { id: "a-16-n-9", actionTypeId: "TRANSFORM_MOVE", config: { delay: 0, easing: "", duration: 500, target: {}, yValue: 30, xUnit: "PX", yUnit: "%", zUnit: "PX" } },
                      { id: "a-16-n-11", actionTypeId: "TRANSFORM_SCALE", config: { delay: 0, easing: "", duration: 500, target: {}, xValue: 0.8, yValue: 0.8, locked: true } },
                      { id: "a-16-n-10", actionTypeId: "STYLE_OPACITY", config: { delay: 0, easing: "", duration: 500, target: {}, value: 0, unit: "" } },
                      { id: "a-16-n-12", actionTypeId: "TRANSFORM_MOVE", config: { delay: 0, easing: "", duration: 500, target: {}, yValue: 30, xUnit: "PX", yUnit: "%", zUnit: "PX" } },
                      { id: "a-16-n-14", actionTypeId: "STYLE_OPACITY", config: { delay: 0, easing: "", duration: 500, target: {}, value: 0, unit: "" } },
                      { id: "a-16-n-13", actionTypeId: "TRANSFORM_SCALE", config: { delay: 0, easing: "", duration: 500, target: {}, xValue: 0.8, yValue: 0.8, locked: true } },
                      { id: "a-16-n-15", actionTypeId: "TRANSFORM_MOVE", config: { delay: 0, easing: "", duration: 500, target: {}, yValue: 30, xUnit: "PX", yUnit: "%", zUnit: "PX" } },
                      { id: "a-16-n-17", actionTypeId: "TRANSFORM_SCALE", config: { delay: 0, easing: "", duration: 500, target: {}, xValue: 0.8, yValue: 0.8, locked: true } },
                      { id: "a-16-n-16", actionTypeId: "STYLE_OPACITY", config: { delay: 0, easing: "", duration: 500, target: {}, value: 0, unit: "" } },
                  ],
              },
              {
                  actionItems: [
                      { id: "a-16-n-18", actionTypeId: "TRANSFORM_MOVE", config: { delay: 0, easing: "ease", duration: 1000, target: {}, yValue: 0, xUnit: "PX", yUnit: "%", zUnit: "PX" } },
                      { id: "a-16-n-20", actionTypeId: "STYLE_OPACITY", config: { delay: 0, easing: "ease", duration: 1000, target: {}, value: 1, unit: "" } },
                      { id: "a-16-n-19", actionTypeId: "TRANSFORM_SCALE", config: { delay: 0, easing: "ease", duration: 1000, target: {}, xValue: 1, yValue: 1, locked: true } },
                      { id: "a-16-n-21", actionTypeId: "TRANSFORM_MOVE", config: { delay: 150, easing: "ease", duration: 1000, target: {}, yValue: 0, xUnit: "PX", yUnit: "%", zUnit: "PX" } },
                      { id: "a-16-n-23", actionTypeId: "TRANSFORM_SCALE", config: { delay: 150, easing: "ease", duration: 1000, target: {}, xValue: 1, yValue: 1, locked: true } },
                      { id: "a-16-n-22", actionTypeId: "STYLE_OPACITY", config: { delay: 150, easing: "ease", duration: 1000, target: {}, value: 1, unit: "" } },
                      { id: "a-16-n-24", actionTypeId: "TRANSFORM_MOVE", config: { delay: 300, easing: "ease", duration: 1000, target: {}, yValue: 0, xUnit: "PX", yUnit: "%", zUnit: "PX" } },
                      { id: "a-16-n-26", actionTypeId: "STYLE_OPACITY", config: { delay: 300, easing: "ease", duration: 1000, target: {}, value: 1, unit: "" } },
                      { id: "a-16-n-25", actionTypeId: "TRANSFORM_SCALE", config: { delay: 300, easing: "ease", duration: 1000, target: {}, xValue: 1, yValue: 1, locked: true } },
                      {
                          id: "a-16-n-33",
                          actionTypeId: "TRANSFORM_MOVE",
                          config: { delay: 300, easing: "ease", duration: 1600, target: { selector: ".navbar", selectorGuids: ["e120672f-745f-faa1-71e7-c904666db13c"] }, yValue: 0, xUnit: "PX", yUnit: "%", zUnit: "PX" },
                      },
                      {
                          id: "a-16-n-34",
                          actionTypeId: "STYLE_OPACITY",
                          config: { delay: 300, easing: "ease", duration: 1600, target: { selector: ".navbar", selectorGuids: ["e120672f-745f-faa1-71e7-c904666db13c"] }, value: 1, unit: "" },
                      },
                      { id: "a-16-n-29", actionTypeId: "TRANSFORM_SCALE", config: { delay: 450, easing: "ease", duration: 1000, target: {}, xValue: 1, yValue: 1, locked: true } },
                      { id: "a-16-n-28", actionTypeId: "STYLE_OPACITY", config: { delay: 450, easing: "ease", duration: 1000, target: {}, value: 1, unit: "" } },
                      { id: "a-16-n-27", actionTypeId: "TRANSFORM_MOVE", config: { delay: 450, easing: "ease", duration: 1000, target: {}, yValue: 0, xUnit: "PX", yUnit: "%", zUnit: "PX" } },
                      { id: "a-16-n-30", actionTypeId: "TRANSFORM_MOVE", config: { delay: 600, easing: "ease", duration: 1000, target: {}, yValue: 0, xUnit: "PX", yUnit: "%", zUnit: "PX" } },
                      { id: "a-16-n-32", actionTypeId: "STYLE_OPACITY", config: { delay: 600, easing: "ease", duration: 1000, target: {}, value: 1, unit: "" } },
                      { id: "a-16-n-31", actionTypeId: "TRANSFORM_SCALE", config: { delay: 600, easing: "ease", duration: 1000, target: {}, xValue: 1, yValue: 1, locked: true } },
                  ],
              },
          ],
          useFirstGroupAsInitialState: true,
      ...
      "a-20": {
          id: "a-20",
          title: "ðŸ‘† Links -> Hover Out",
          actionItemGroups: [
              {
                  actionItems: [
                      { id: "a-20-n", actionTypeId: "STYLE_SIZE", config: { delay: 0, easing: "ease", duration: 500, target: {}, widthValue: 20, heightValue: 20, widthUnit: "px", heightUnit: "px", locked: false } },
                      { id: "a-20-n-2", actionTypeId: "STYLE_BORDER", config: { delay: 0, easing: "ease", duration: 500, target: {}, globalSwatchId: "", rValue: 255, bValue: 255, gValue: 255, aValue: 0 } },
                      { id: "a-20-n-3", actionTypeId: "STYLE_BACKGROUND_COLOR", config: { delay: 0, easing: "ease", duration: 500, target: {}, globalSwatchId: "", rValue: 0, bValue: 0, gValue: 0, aValue: 1 } },
                  ],
              },
          ],
          useFirstGroupAsInitialState: false,
      ...
      "a-24": {
          id: "a-24",
          title: "ðŸ‘† Link Block Animation 03 -> Hover Out 2",
          actionItemGroups: [
              {
                  actionItems: [
                      {
                          ...
                          config: {
                              ...
                              target: {
                                  ...
                                  selectorGuids: ["e7362ff3-1cb5-d07c-af2e-df27fc2f3066", "66d8d1ec-1518-3b82-a8ae-642dc968cbed", "66d8d1ec-1518-3b82-a8ae-642dc968cbf2"],
                              },
                              xValue: 101,
                              xUnit: "%",
                              yUnit: "PX",
                      ...
                      },
                      {
                          ...
                          config: {
                              ...
                              easing: "ease",
                              duration: 400,
                              target: { useEventTarget: "CHILDREN", selector: ".link-block-underline._02", selectorGuids: ["e7362ff3-1cb5-d07c-af2e-df27fc2f3066", "66d8d1ec-1518-3b82-a8ae-642dc968cbea"] },
                              xValue: 150,
                              xUnit: "%",
                              yUnit: "PX",
                              zUnit: "PX",
                  ...
                  actionItems: [
                      {
                          ...
                          config: {
                              ...
                              easing: "",
                              duration: 500,
                              target: { useEventTarget: "CHILDREN", selector: ".style-guide-home-text", selectorGuids: ["66d8d1ec-1518-3b82-a8ae-642dc968cbcd"] },
                              yValue: 0,
                              xUnit: "PX",
                              yUnit: "%",
                              zUnit: "PX",
      ...
      "a-22": {
          id: "a-22",
          title: "ðŸ‘† Links -> Hover On",
          actionItemGroups: [
              {
                  actionItems: [
                      { id: "a-22-n", actionTypeId: "STYLE_SIZE", config: { delay: 0, easing: "", duration: 500, target: {}, widthValue: 20, heightValue: 20, widthUnit: "px", heightUnit: "px", locked: false } },
                      { id: "a-22-n-2", actionTypeId: "STYLE_BORDER", config: { delay: 0, easing: "", duration: 500, target: {}, globalSwatchId: "", rValue: 255, bValue: 255, gValue: 255, aValue: 0 } },
                      { id: "a-22-n-3", actionTypeId: "STYLE_BACKGROUND_COLOR", config: { delay: 0, easing: "", duration: 500, target: {}, globalSwatchId: "", rValue: 0, bValue: 0, gValue: 0, aValue: 1 } },
                  ],
              },
              {
                  actionItems: [
                      { id: "a-22-n-4", actionTypeId: "STYLE_BORDER", config: { delay: 0, easing: "bouncePast", duration: 500, target: {}, globalSwatchId: "", rValue: 190, bValue: 190, gValue: 190, aValue: 1 } },
                      { id: "a-22-n-5", actionTypeId: "STYLE_BACKGROUND_COLOR", config: { delay: 0, easing: "bouncePast", duration: 500, target: {}, globalSwatchId: "", rValue: 219, bValue: 219, gValue: 219, aValue: 0.45 } },
                      { id: "a-22-n-6", actionTypeId: "STYLE_SIZE", config: { delay: 0, easing: "bouncePast", duration: 500, target: {}, widthValue: 50, heightValue: 50, widthUnit: "px", heightUnit: "px", locked: false } },
                  ],
              },
          ],
          useFirstGroupAsInitialState: true,
      ...
      "a-21": {
          id: "a-21",
          title: "ðŸ‘† Return Home -> Hover Out",
          actionItemGroups: [
              {
                  actionItems: [
                      {
      ...
      "a-23": {
          id: "a-23",
          title: "ðŸ‘† Link Block Animation 03 -> Hover In 2",
          actionItemGroups: [
              {
                  actionItems: [
                      {
                  ...
                  actionItems: [
                      {
                          id: "a-28-n",
                          actionTypeId: "STYLE_OPACITY",
                          config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: true, id: "604b35876a71cb76ac768e33|e74ed22c-3155-00fa-e7e3-df8b5875d506" }, value: 0, unit: "" },
                      },
                  ],
              },
              {
                  actionItems: [
                      {
                          id: "a-28-n-2",
                          actionTypeId: "STYLE_OPACITY",
                          config: { delay: 100, easing: "ease", duration: 1500, target: { useEventTarget: true, id: "604b35876a71cb76ac768e33|e74ed22c-3155-00fa-e7e3-df8b5875d506" }, value: 1, unit: "" },
                      },
                  ],
              },
          ],
      ...
      "a-33": {
          id: "a-33",
          title: "ðŸ‘† Cards -> Hover On",
          actionItemGroups: [
              {
                  actionItems: [
                      { id: "a-33-n-5", actionTypeId: "STYLE_OPACITY", config: { delay: 0, easing: "", duration: 500, target: {}, value: 0, unit: "" } },
                      { id: "a-33-n-7", actionTypeId: "GENERAL_DISPLAY", config: { delay: 0, easing: "", duration: 0, target: {}, value: "flex" } },
                  ],
              },
              { actionItems: [{ id: "a-33-n-6", actionTypeId: "STYLE_OPACITY", config: { delay: 0, easing: "", duration: 500, target: {}, value: 0.1, unit: "" } }] },
          ],
          useFirstGroupAsInitialState: true,
          createdOn: 1638369025313,
      },
      "a-34": {
          id: "a-34",
          title: "ðŸ‘† Cards -> Hover Out",
          actionItemGroups: [{ actionItems: [{ id: "a-34-n-3", actionTypeId: "STYLE_OPACITY", config: { delay: 0, easing: "", duration: 500, target: {}, value: 0, unit: "" } }] }],
          useFirstGroupAsInitialState: false,
          createdOn: 1638369025313,
      },
      "a-35": {
          id: "a-35",
          title: "ðŸ‘† Interegration Logo -> Hover On",
          actionItemGroups: [
              { actionItems: [{ id: "a-35-n", actionTypeId: "STYLE_OPACITY", config: { delay: 0, easing: "", duration: 500, target: {}, value: 0, unit: "" } }] },
              { actionItems: [{ id: "a-35-n-2", actionTypeId: "STYLE_OPACITY", config: { delay: 0, easing: "ease", duration: 1300, target: {}, value: 0.4, unit: "" } }] },
          ],
          useFirstGroupAsInitialState: true,
          createdOn: 1638369025313,
      },
      "a-36": {
          id: "a-36",
          title: "ðŸ‘† Interegration Logo -> Hover Out",
          actionItemGroups: [{ actionItems: [{ id: "a-36-n-2", actionTypeId: "STYLE_OPACITY", config: { delay: 0, easing: "ease", duration: 1300, target: {}, value: 0, unit: "" } }] }],
          useFirstGroupAsInitialState: false,
          createdOn: 1638369025313,
      },
      "a-49": {
          id: "a-49",
          title: "â™¾ Infinite Hero Section Loop",
          actionItemGroups: [
              {
                  actionItems: [
                      {
                          id: "a-49-n",
                          actionTypeId: "TRANSFORM_MOVE",
                          config: { delay: 0, easing: "", duration: 500, target: { selector: ".infinite-ai-images-grid", selectorGuids: ["c61dca36-75f4-f270-bb40-cd2877de3929"] }, xValue: 0, xUnit: "%", yUnit: "PX", zUnit: "PX" },
                      },
                  ],
              },
              {
                  actionItems: [
                      {
                          id: "a-49-n-2",
                          actionTypeId: "TRANSFORM_MOVE",
                          config: { delay: 0, easing: "", duration: 40000, target: { selector: ".infinite-ai-images-grid", selectorGuids: ["c61dca36-75f4-f270-bb40-cd2877de3929"] }, xValue: -100, xUnit: "%", yUnit: "PX", zUnit: "PX" },
                      },
                  ],
              },
              {
                  actionItems: [
                      {
                          id: "a-49-n-3",
                          actionTypeId: "TRANSFORM_MOVE",
                          config: { delay: 0, easing: "", duration: 0, target: { selector: ".infinite-ai-images-grid", selectorGuids: ["c61dca36-75f4-f270-bb40-cd2877de3929"] }, xValue: 0, xUnit: "%", yUnit: "PX", zUnit: "PX" },
                      },
                  ],
              },
          ],
          useFirstGroupAsInitialState: true,
          createdOn: 1673428898711,
      },
      "a-50": {
          id: "a-50",
          title: "Infnite Image Look-At Mouse",
                          ...
                          actionItems: [
                              {
                                  ...
                                  config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: true, id: "c34b435b-0809-a8ce-f4e3-d841430be5b7" }, yValue: -10, xUnit: "DEG", yUnit: "deg", zUnit: "DEG" },
                              },
                          ],
                      },
                      {
                          ...
                          actionItems: [
                              {
                                  id: "a-50-n-3",
                                  actionTypeId: "TRANSFORM_ROTATE",
                                  config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: true, id: "c34b435b-0809-a8ce-f4e3-d841430be5b7" }, xValue: 10, xUnit: "deg", yUnit: "DEG", zUnit: "DEG" },
                              },
                          ],
                      },
                      {
          ...
          createdOn: 1673428997628,
      },
      "a-51": {
          id: "a-51",
          title: "â™¾ Infinite Image -> Hover On",
          actionItemGroups: [
              {
                  actionItems: [
                      {
                          id: "a-51-n",
                          actionTypeId: "TRANSFORM_MOVE",
                          config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: true, id: "c34b435b-0809-a8ce-f4e3-d841430be5b7" }, yValue: 0, xUnit: "PX", yUnit: "px", zUnit: "PX" },
                      },
                  ],
              },
              {
                  actionItems: [
                      {
                          id: "a-51-n-2",
                          actionTypeId: "TRANSFORM_MOVE",
                          config: { delay: 0, easing: "ease", duration: 900, target: { useEventTarget: true, id: "c34b435b-0809-a8ce-f4e3-d841430be5b7" }, yValue: -20, xUnit: "PX", yUnit: "px", zUnit: "PX" },
                      },
                  ],
              },
          ],
          useFirstGroupAsInitialState: true,
          createdOn: 1673429121909,
      },
      "a-52": {
          id: "a-52",
          title: "â™¾ Infinite Image -> Hover Out",
          actionItemGroups: [
              {
                  actionItems: [
                      {
                          id: "a-52-n-2",
                          actionTypeId: "TRANSFORM_MOVE",
                          config: { delay: 0, easing: "ease", duration: 900, target: { useEventTarget: true, id: "c34b435b-0809-a8ce-f4e3-d841430be5b7" }, yValue: 0, xUnit: "PX", yUnit: "px", zUnit: "PX" },
                      },
                  ],
              },
          ],
      ...
      "a-53": {
          id: "a-53",
          title: "ðŸŽ† Card On Scroll Animation",
          continuousParameterGroups: [
              {
                  id: "a-53-p",
                          ...
                          actionItems: [
                              {
                                  ...
                                  config: {
                                      ...
                                      easing: "",
                                      duration: 500,
                                      target: { useEventTarget: "CHILDREN", selector: ".grey-card-icon-holder", selectorGuids: ["c1428918-f2ce-6a38-4887-bac851632166"] },
                                      yValue: 20,
                                      xUnit: "PX",
                                      yUnit: "px",
                                      zUnit: "PX",
                              ...
                              },
                              {
                                  id: "a-53-n-3",
                                  actionTypeId: "STYLE_OPACITY",
                                  config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: "CHILDREN", selector: ".grey-card-icon-holder", selectorGuids: ["c1428918-f2ce-6a38-4887-bac851632166"] }, value: 0, unit: "" },
                              },
                              {
                                  id: "a-53-n-4",
                                  actionTypeId: "TRANSFORM_MOVE",
                                  config: {
                                      ...
                                      easing: "",
                                      duration: 500,
                                      target: { useEventTarget: "CHILDREN", selector: ".card-title-holder", selectorGuids: ["ccb97650-b2f5-08fa-32c6-54641c26c08b"] },
                                      yValue: 20,
                                      xUnit: "PX",
                                      yUnit: "px",
                                      zUnit: "PX",
                              ...
                              },
                              {
                                  id: "a-53-n-5",
                                  actionTypeId: "STYLE_OPACITY",
                                  config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: "CHILDREN", selector: ".card-title-holder", selectorGuids: ["ccb97650-b2f5-08fa-32c6-54641c26c08b"] }, value: 0, unit: "" },
                              },
                              {
                                  id: "a-53-n-6",
                                  actionTypeId: "TRANSFORM_MOVE",
                                  config: {
                                      ...
                                      easing: "",
                                      duration: 500,
                                      target: { useEventTarget: "CHILDREN", selector: ".card-paraghraph-holder", selectorGuids: ["1ed1807e-cd96-4b08-1936-a82ab72a2398"] },
                                      yValue: 20,
                                      xUnit: "PX",
                                      yUnit: "px",
                                      zUnit: "PX",
                              ...
                              },
                              {
                                  id: "a-53-n-7",
                                  actionTypeId: "STYLE_OPACITY",
                                  config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: "CHILDREN", selector: ".card-paraghraph-holder", selectorGuids: ["1ed1807e-cd96-4b08-1936-a82ab72a2398"] }, value: 0, unit: "" },
                              },
                              { id: "a-53-n-8", actionTypeId: "TRANSFORM_MOVE", config: { delay: 0, easing: "", duration: 500, target: {}, yValue: 20, xUnit: "PX", yUnit: "px", zUnit: "PX" } },
                              { id: "a-53-n-9", actionTypeId: "STYLE_OPACITY", config: { delay: 0, easing: "", duration: 500, target: {}, value: 0, unit: "" } },
                              {
                                  id: "a-53-n-10",
                                  actionTypeId: "TRANSFORM_MOVE",
                                  config: {
                                      ...
                                      easing: "",
                                      duration: 500,
                                      target: { useEventTarget: "CHILDREN", selector: ".grey-card-image-holder", selectorGuids: ["7df77123-3d54-81f9-2817-a0eddf0c99ae"] },
                                      xValue: 90,
                                      xUnit: "px",
                                      yUnit: "PX",
                                      zUnit: "PX",
                              ...
                              },
                              {
                                  id: "a-53-n-20",
                                  actionTypeId: "TRANSFORM_MOVE",
                                  config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: true, id: "63bc0ce6938b48c6107ca08b|eaf7432c-fa80-bdc6-2db3-6199aa2326cb" }, yValue: 60, xUnit: "PX", yUnit: "px", zUnit: "PX" },
                              },
                          ],
                      },
                      {
                          ...
                          actionItems: [
                              ...
                              },
                              {
                                  id: "a-53-n-12",
                                  actionTypeId: "STYLE_OPACITY",
                                  config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: "CHILDREN", selector: ".grey-card-icon-holder", selectorGuids: ["c1428918-f2ce-6a38-4887-bac851632166"] }, value: 1, unit: "" },
                              },
                          ],
                      },
                      {
                          ...
                          actionItems: [
                              ...
                              },
                              {
                                  id: "a-53-n-14",
                                  actionTypeId: "STYLE_OPACITY",
                                  config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: "CHILDREN", selector: ".card-title-holder", selectorGuids: ["ccb97650-b2f5-08fa-32c6-54641c26c08b"] }, value: 1, unit: "" },
                              },
                          ],
                      },
                      {
                          ...
                          actionItems: [
                              ...
                              },
                              {
                                  id: "a-53-n-16",
                                  actionTypeId: "STYLE_OPACITY",
                                  config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: "CHILDREN", selector: ".card-paraghraph-holder", selectorGuids: ["1ed1807e-cd96-4b08-1936-a82ab72a2398"] }, value: 1, unit: "" },
                              },
                              { id: "a-53-n-17", actionTypeId: "TRANSFORM_MOVE", config: { delay: 0, easing: "", duration: 500, target: {}, yValue: 0, xUnit: "PX", yUnit: "px", zUnit: "PX" } },
                              { id: "a-53-n-18", actionTypeId: "STYLE_OPACITY", config: { delay: 0, easing: "", duration: 500, target: {}, value: 1, unit: "" } },
                              {
                                  id: "a-53-n-19",
                                  actionTypeId: "TRANSFORM_MOVE",
                                  config: {
                              ...
                              },
                              {
                                  id: "a-53-n-21",
                                  actionTypeId: "TRANSFORM_MOVE",
                                  config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: true, id: "63bc0ce6938b48c6107ca08b|eaf7432c-fa80-bdc6-2db3-6199aa2326cb" }, yValue: 0, xUnit: "PX", yUnit: "px", zUnit: "PX" },
                              },
                          ],
                      },
                  ],
          ...
          createdOn: 1673431860474,
      },
      "a-54": {
          id: "a-54",
          title: "âœï¸ Generate Section",
          actionItemGroups: [
              {
                  actionItems: [
                      {
                          ...
                          config: {
                              ...
                              easing: "",
                              duration: 500,
                              target: { useEventTarget: "CHILDREN", selector: ".generate-title", selectorGuids: ["c5dc4157-bb4c-59ec-bfc1-d5b3165fc7a4"] },
                              widthValue: 0,
                              widthUnit: "px",
                              heightUnit: "PX",
                              locked: false,
                      ...
                      },
                      {
                          id: "a-54-n-8",
                          actionTypeId: "STYLE_OPACITY",
                          config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: "CHILDREN", selector: ".generate-section-image-holder", selectorGuids: ["bea40bc1-19ad-7bdf-342f-7ab1bfd2cc44"] }, value: 0, unit: "" },
                      },
                      {
                          id: "a-54-n-7",
                          actionTypeId: "TRANSFORM_SCALE",
                          config: {
                              ...
                              easing: "",
                              duration: 500,
                              target: { useEventTarget: "CHILDREN", selector: ".generate-section-image-holder", selectorGuids: ["bea40bc1-19ad-7bdf-342f-7ab1bfd2cc44"] },
                              xValue: 0.9,
                              yValue: 0.9,
                              locked: true,
                          },
                      ...
                      },
                      {
                          id: "a-54-n-5",
                          actionTypeId: "STYLE_OPACITY",
                          config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: "CHILDREN", selector: ".generate-description-holder", selectorGuids: ["05c6f3f8-3601-a828-f8f6-efbc12c67e01"] }, value: 0, unit: "" },
                      },
                      {
                          id: "a-54-n-4",
                          actionTypeId: "TRANSFORM_MOVE",
                          config: {
                              ...
                              easing: "",
                              duration: 500,
                              target: { useEventTarget: "CHILDREN", selector: ".generate-description-holder", selectorGuids: ["05c6f3f8-3601-a828-f8f6-efbc12c67e01"] },
                              yValue: 30,
                              xUnit: "PX",
                              yUnit: "px",
                              zUnit: "PX",
                      ...
                      },
                      {
                          id: "a-54-n-3",
                          actionTypeId: "STYLE_OPACITY",
                          config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: "CHILDREN", selector: ".generate-title-holder", selectorGuids: ["13106482-3af1-b94a-7435-bbc81efd2c3b"] }, value: 0, unit: "" },
                      },
                      {
                          id: "a-54-n-2",
                          actionTypeId: "TRANSFORM_MOVE",
                          config: {
                              ...
                              easing: "",
                              duration: 500,
                              target: { useEventTarget: "CHILDREN", selector: ".generate-title-holder", selectorGuids: ["13106482-3af1-b94a-7435-bbc81efd2c3b"] },
                              yValue: 30,
                              xUnit: "PX",
                              yUnit: "px",
                              zUnit: "PX",
              ...
              },
              {
                  actionItems: [
                      ...
                      },
                      {
                          id: "a-54-n-10",
                          actionTypeId: "STYLE_OPACITY",
                          config: { delay: 700, easing: "ease", duration: 700, target: { useEventTarget: "CHILDREN", selector: ".generate-title-holder", selectorGuids: ["13106482-3af1-b94a-7435-bbc81efd2c3b"] }, value: 1, unit: "" },
                      },
                      {
                          id: "a-54-n-11",
                          actionTypeId: "TRANSFORM_MOVE",
          ...
          useFirstGroupAsInitialState: true,
          createdOn: 1673432431687,
      },
      "a-56": {
          id: "a-56",
          title: "Mobile Infinite Auto Switch",
          actionItemGroups: [
              {
                  actionItems: [
                      {
                          id: "a-56-n",
                          actionTypeId: "TRANSFORM_MOVE",
                          config: { delay: 0, easing: "", duration: 500, target: { selector: ".text-auto-switch", selectorGuids: ["d322b1e3-1547-91b2-3442-1557bd0efe3b"] }, yValue: 0, xUnit: "PX", yUnit: "%", zUnit: "PX" },
                      },
                  ],
              },
              {
                  actionItems: [
                      {
                          id: "a-56-n-2",
                          actionTypeId: "TRANSFORM_MOVE",
                          config: { delay: 1000, easing: "ease", duration: 800, target: { selector: ".text-auto-switch", selectorGuids: ["d322b1e3-1547-91b2-3442-1557bd0efe3b"] }, yValue: -100, xUnit: "PX", yUnit: "%", zUnit: "PX" },
                      },
                  ],
              },
              {
                  actionItems: [
                      {
                          id: "a-56-n-3",
                          actionTypeId: "TRANSFORM_MOVE",
                          config: { delay: 2000, easing: "ease", duration: 800, target: { selector: ".text-auto-switch", selectorGuids: ["d322b1e3-1547-91b2-3442-1557bd0efe3b"] }, yValue: -200, xUnit: "PX", yUnit: "%", zUnit: "PX" },
                      },
                  ],
              },
              {
                  actionItems: [
                      {
                          id: "a-56-n-4",
                          actionTypeId: "TRANSFORM_MOVE",
                          config: { delay: 2000, easing: "ease", duration: 800, target: { selector: ".text-auto-switch", selectorGuids: ["d322b1e3-1547-91b2-3442-1557bd0efe3b"] }, yValue: -300, xUnit: "PX", yUnit: "%", zUnit: "PX" },
                      },
                  ],
              },
              {
                  actionItems: [
                      {
                          id: "a-56-n-5",
                          actionTypeId: "TRANSFORM_MOVE",
                          config: { delay: 2000, easing: "ease", duration: 800, target: { selector: ".text-auto-switch", selectorGuids: ["d322b1e3-1547-91b2-3442-1557bd0efe3b"] }, yValue: -400, xUnit: "PX", yUnit: "%", zUnit: "PX" },
                      },
                  ],
              },
          ],
      ...
      "a-60": {
          id: "a-60",
          title: "ðŸ–± White Background Expand",
          continuousParameterGroups: [
              {
                  id: "a-60-p",
                  type: "SCROLL_PROGRESS",
                          ...
                          actionItems: [
                              {
                                  ...
                                  config: {
                                      ...
                                      easing: "",
                                      duration: 500,
                                      target: { useEventTarget: "CHILDREN", selector: ".grey-background", selectorGuids: ["d299b077-f80a-9a64-b395-1bab1488fa44"] },
                                      widthValue: 100,
                                      widthUnit: "%",
                                      heightUnit: "PX",
                                      locked: false,
          ...
          createdOn: 1673860489504,
      },
      "a-61": {
          id: "a-61",
          title: "ðŸŽ† Card On Scroll Animation MOBILE",
          continuousParameterGroups: [
              {
                  id: "a-61-p",
                  type: "SCROLL_PROGRESS",
                  ...
                  continuousActionGroups: [
                      {
                          ...
                          actionItems: [
                              ...
                              { id: "a-61-n-7", actionTypeId: "TRANSFORM_MOVE", config: { delay: 0, easing: "", duration: 500, target: {}, yValue: 20, xUnit: "PX", yUnit: "px", zUnit: "PX" } },
                              { id: "a-61-n-8", actionTypeId: "STYLE_OPACITY", config: { delay: 0, easing: "", duration: 500, target: {}, value: 0, unit: "" } },
                              {
                                  id: "a-61-n-9",
                                  actionTypeId: "TRANSFORM_MOVE",
                                  config: {
                      ...
                      },
                      {
                          ...
                          actionItems: [
                              ...
                              { id: "a-61-n-17", actionTypeId: "TRANSFORM_MOVE", config: { delay: 0, easing: "", duration: 500, target: {}, yValue: 0, xUnit: "PX", yUnit: "px", zUnit: "PX" } },
                              { id: "a-61-n-18", actionTypeId: "STYLE_OPACITY", config: { delay: 0, easing: "", duration: 500, target: {}, value: 1, unit: "" } },
                              {
                                  id: "a-61-n-20",
                                  actionTypeId: "TRANSFORM_MOVE",
                                  config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: true, id: "63bc0ce6938b48c6107ca08b|eaf7432c-fa80-bdc6-2db3-6199aa2326cb" }, yValue: 0, xUnit: "PX", yUnit: "px", zUnit: "PX" },
      ...
      "a-62": {
          id: "a-62",
          title: "ðŸ’¬â™¾ Footer Infinite Loop Text",
          actionItemGroups: [
              { actionItems: [{ id: "a-62-n", actionTypeId: "TRANSFORM_MOVE", config: { delay: 0, easing: "", duration: 500, target: {}, xValue: 0, xUnit: "%", yUnit: "PX", zUnit: "PX" } }] },
              { actionItems: [{ id: "a-62-n-2", actionTypeId: "TRANSFORM_MOVE", config: { delay: 0, easing: "", duration: 40000, target: {}, xValue: -100, xUnit: "%", yUnit: "PX", zUnit: "PX" } }] },
              { actionItems: [{ id: "a-62-n-3", actionTypeId: "TRANSFORM_MOVE", config: { delay: 0, easing: "", duration: 0, target: {}, xValue: 0, xUnit: "%", yUnit: "PX", zUnit: "PX" } }] },
          ],
          useFirstGroupAsInitialState: true,
          createdOn: 1673861814768,
      },
      "a-63": {
          id: "a-63",
                  ...
                  actionItems: [
                      {
                          id: "a-63-n",
                          actionTypeId: "TRANSFORM_MOVE",
                          config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: true, id: "63bc0ce6938b48c6107ca08b|929d74e2-0f92-03e3-438f-132bac7e1644" }, yValue: 20, xUnit: "PX", yUnit: "px", zUnit: "PX" },
                      },
                      {
                          id: "a-63-n-2",
                          actionTypeId: "STYLE_OPACITY",
                          config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: true, id: "63bc0ce6938b48c6107ca08b|929d74e2-0f92-03e3-438f-132bac7e1644" }, value: 0, unit: "" },
                      },
                  ],
              },
              {
                  actionItems: [
                      {
                          id: "a-63-n-4",
                          actionTypeId: "STYLE_OPACITY",
                          config: { delay: 1000, easing: "ease", duration: 1000, target: { useEventTarget: true, id: "63bc0ce6938b48c6107ca08b|929d74e2-0f92-03e3-438f-132bac7e1644" }, value: 1, unit: "" },
                      },
                      {
                          id: "a-63-n-3",
                          actionTypeId: "TRANSFORM_MOVE",
                          config: { delay: 1000, easing: "ease", duration: 1000, target: { useEventTarget: true, id: "63bc0ce6938b48c6107ca08b|929d74e2-0f92-03e3-438f-132bac7e1644" }, yValue: 0, xUnit: "PX", yUnit: "px", zUnit: "PX" },
                      },
                  ],
              },
          ],
          useFirstGroupAsInitialState: true,
          createdOn: 1674661423711,
      },
      "a-64": {
          id: "a-64",
          title: "Nav Add Bg and Blur",
          continuousParameterGroups: [
              {
                  id: "a-64-p",
                  type: "SCROLL_PROGRESS",
                          ...
                          actionItems: [
                              {
                                  ...
                                  config: {
                                      ...
                                      easing: "",
                                      duration: 500,
                                      target: { selector: ".nav-menu-container", selectorGuids: ["ce88a8fd-a045-613d-2bfb-d48d93b0d60d"] },
                                      globalSwatchId: "",
                                      rValue: 255,
                                      bValue: 255,
                                      gValue: 255,
          ...
          createdOn: 1676391790384,
      },
      "a-65": {
          id: "a-65",
          title: "Hero Pattern - Follow Mouse",
          continuousParameterGroups: [
              {
                  id: "a-65-p",
                  type: "MOUSE_X",
                          ...
                          actionItems: [
                              {
                                  id: "a-65-n",
                                  actionTypeId: "TRANSFORM_MOVE",
                                  config: { delay: 0, easing: "", duration: 500, target: { selector: ".hero-bg-grid", selectorGuids: ["68426205-1fea-589d-7347-0ecbf03ea370"] }, xValue: -10, xUnit: "%", yUnit: "PX", zUnit: "PX" },
                              },
                          ],
                      },
                      {
                          ...
                          actionItems: [
                              {
                                  id: "a-65-n-3",
                                  actionTypeId: "TRANSFORM_MOVE",
                                  config: { delay: 0, easing: "", duration: 500, target: { selector: ".hero-bg-grid", selectorGuids: ["68426205-1fea-589d-7347-0ecbf03ea370"] }, yValue: -10, xUnit: "PX", yUnit: "%", zUnit: "PX" },
                              },
                          ],
                      },
                      {
                          ...
                          actionItems: [
                              {
                                  id: "a-65-n-4",
                                  actionTypeId: "TRANSFORM_MOVE",
                                  config: { delay: 0, easing: "", duration: 500, target: { selector: ".hero-bg-grid", selectorGuids: ["68426205-1fea-589d-7347-0ecbf03ea370"] }, yValue: 5, xUnit: "PX", yUnit: "%", zUnit: "PX" },
                              },
                          ],
                      },
                  ],
          ...
          createdOn: 1676397692618,
      },
      "a-66": {
          id: "a-66",
          title: "Circle Animate on Scroll",
          continuousParameterGroups: [
              {
                  id: "a-66-p",
                  type: "SCROLL_PROGRESS",
                          ...
                          actionItems: [
                              {
                                  ...
                                  config: {
                                      ...
                                      easing: "",
                                      duration: 500,
                                      target: { useEventTarget: "CHILDREN", selector: ".circle-container", selectorGuids: ["f6de913d-148c-a260-634c-478aba22549d"] },
                                      zValue: 0,
                                      xUnit: "DEG",
                                      yUnit: "DEG",
                                      zUnit: "deg",
                              ...
                              },
                              {
                                  ...
                                  config: {
                                      ...
                                      easing: "",
                                      duration: 500,
                                      target: { useEventTarget: "CHILDREN", selector: ".center-circle", selectorGuids: ["d746d511-58ce-519c-c6e6-ed149a07fde3"] },
                                      zValue: 0,
                                      xUnit: "DEG",
                                      yUnit: "DEG",
                                      zUnit: "deg",
                          ...
                          actionItems: [
                              {
                                  ...
                                  config: {
                                      ...
                                      easing: "",
                                      duration: 500,
                                      target: { useEventTarget: "CHILDREN", selector: ".circle-title-holder._1", selectorGuids: ["c6962d89-a2d4-f04e-20b9-01f7e0a1e309", "f1ec93c1-685a-3e30-1a7a-e0f912e3eca3"] },
                                      yValue: 60,
                                      zValue: -3,
                                      xUnit: "PX",
                                      yUnit: "%",
                              ...
                              },
                              {
                                  id: "a-66-n-35",
                                  actionTypeId: "STYLE_OPACITY",
                                  config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: "CHILDREN", selector: ".circle-prompt-box", selectorGuids: ["13d5d41f-25e4-ea1d-187c-45879ad9b708"] }, value: 0, unit: "" },
                              },
                          ],
                      },
                      {
                          ...
                          actionItems: [
                              ...
                              },
                              {
                                  id: "a-66-n-36",
                                  actionTypeId: "STYLE_OPACITY",
                                  config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: "CHILDREN", selector: ".circle-prompt-box", selectorGuids: ["13d5d41f-25e4-ea1d-187c-45879ad9b708"] }, value: 1, unit: "" },
                              },
                          ],
                      },
                      {
                          ...
                          actionItems: [
                              {
                                  ...
                                  config: {
                                      ...
                                      easing: "",
                                      duration: 500,
                                      target: { useEventTarget: "CHILDREN", selector: ".circle-title-holder._2", selectorGuids: ["c6962d89-a2d4-f04e-20b9-01f7e0a1e309", "65cc505d-552b-7a1d-ad6e-95e72e11a2e3"] },
                                      yValue: 60,
                                      zValue: -3,
                                      xUnit: "PX",
                                      yUnit: "%",
                          ...
                          actionItems: [
                              {
                                  ...
                                  config: {
                                      ...
                                      easing: "",
                                      duration: 500,
                                      target: { useEventTarget: "CHILDREN", selector: ".circle-title-holder._3", selectorGuids: ["c6962d89-a2d4-f04e-20b9-01f7e0a1e309", "cf77d4c6-dd60-d302-9263-c94006a1564a"] },
                                      yValue: 60,
                                      zValue: -3,
                                      xUnit: "PX",
                                      yUnit: "%",
          ...
          createdOn: 1677347290100,
      },
      "a-67": {
          id: "a-67",
          title: "Circle Image Hover Animation",
          actionItemGroups: [
              {
                  actionItems: [
                      {
                          ...
                          config: {
                              ...
                              easing: "",
                              duration: 500,
                              target: { useEventTarget: "CHILDREN", selector: ".circle-image-holder", selectorGuids: ["f659061f-1a90-608b-5277-04bb81a83988"] },
                              yValue: 40,
                              xUnit: "PX",
                              yUnit: "px",
                              zUnit: "PX",
                      ...
                      },
                      {
                          ...
                          config: {
                              ...
                              easing: "",
                              duration: 500,
                              target: { useEventTarget: "CHILDREN", selector: ".circle-item-text-container", selectorGuids: ["550919dd-d5a0-5bda-6e8e-3f538c80f2d0"] },
                              yValue: 100,
                              xUnit: "PX",
                              yUnit: "%",
                              zUnit: "PX",
          ...
          useFirstGroupAsInitialState: true,
          createdOn: 1677349567100,
      },
      "a-68": {
          id: "a-68",
          title: "Circle Image Hover Out Animation",
          actionItemGroups: [
              {
                  actionItems: [
                      {
          ...
          actionItemGroups: [
              {
                  actionItems: [
                      {
                          actionTypeId: "TRANSFORM_SCALE",
                          config: { delay: 0, easing: "outQuart", duration: 250, target: { id: "N/A", appliesTo: "TRIGGER_ELEMENT", useEventTarget: true }, xValue: 0.7500000000000001, yValue: 0.7500000000000001 },
                      },
                  ],
              },
              { actionItems: [{ actionTypeId: "TRANSFORM_SCALE", config: { delay: 0, easing: "outElastic", duration: 1000, target: { id: "N/A", appliesTo: "TRIGGER_ELEMENT", useEventTarget: true }, xValue: 1, yValue: 1 } }] },
          ],
      },
  },
  site: {
